...
Contributing to awkward requires human judgment, contextual understanding, and familiarity with awkward’s structure and goals.
Please refrain from submitting issues or pull requests generated by fully-automated tools.
...
Please be mindful of the reviewers time when you submit the PR assisted by AI both in content and PR description. Reviewers should not be expected to unknowingly converse with an AI or infer authorship during review. Contributors remain fully responsible for understanding, defending, and maintaining all submitted changes, regardless of AI assistance.

If you used AI tools for a significant portion of your contribution, please state so in your PR description.
