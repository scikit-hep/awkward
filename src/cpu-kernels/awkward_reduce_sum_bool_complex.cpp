...
#define FILENAME(line) FILENAME_FOR_EXCEPTIONS_C("src/cpu-kernels/awkward_reduce_sum_bool_complex.cpp", line)
...
ERROR awkward_reduce_sum_bool_complex(
  ...
  int64_t lenparents,
  int64_t outlength) {
  std::cout << "awkward_reduce_sum_bool_complex" << std::endl;
