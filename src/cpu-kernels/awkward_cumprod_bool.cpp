...
ERROR awkward_cumprod_int32_bool(
  int32_t* toptr,
  const bool* fromptr,
  int64_t length,
  const int64_t* offsets,
  int64_t offsetslength,
  int64_t parentslength) {
  return awkward_cumprod_bool<int32_t>(
    toptr,
    fromptr,
    length,
    offsets,
...
ERROR awkward_cumprod_int64_bool(
  int64_t* toptr,
  const bool* fromptr,
  int64_t length,
  const int64_t* offsets,
  int64_t offsetslength,
  int64_t parentslength) {
  return awkward_cumprod_bool<int64_t>(
    toptr,
    fromptr,
    length,
    offsets,
