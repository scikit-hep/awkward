...
ERROR
awkward_ListArray32_num_64(int64_t* tonum,
...
ERROR
awkward_ListArrayU32_num_64(int64_t* tonum,
...
ERROR
awkward_ListArray64_num_64(int64_t* tonum,
...
template <typename T>
ERROR
awkward_RegularArray_num(T* tonum, int64_t size, int64_t length) {
  for (int64_t i = 0; i < length; i++) {
    tonum[i] = size;
  }
  return success();
...
ERROR
awkward_RegularArray_num_64(int64_t* tonum, int64_t size, int64_t length) {
...
ERROR
awkward_ListOffsetArray32_flatten_offsets_64(int64_t* tooffsets,
...
ERROR
awkward_ListOffsetArrayU32_flatten_offsets_64(int64_t* tooffsets,
...
ERROR
awkward_ListOffsetArray64_flatten_offsets_64(int64_t* tooffsets,
...
template <typename T, typename C>
ERROR
awkward_IndexedArray_flatten_none2empty(T* outoffsets,
                                        const C* outindex,
...
ERROR
awkward_IndexedArray32_flatten_none2empty_64(int64_t* outoffsets,
...
ERROR
awkward_IndexedArrayU32_flatten_none2empty_64(int64_t* outoffsets,
...
ERROR
awkward_IndexedArray64_flatten_none2empty_64(int64_t* outoffsets,
...
ERROR
awkward_UnionArray_flatten_length(int64_t* total_length,
...
ERROR
awkward_UnionArray32_flatten_length_64(int64_t* total_length,
...
ERROR
awkward_UnionArrayU32_flatten_length_64(int64_t* total_length,
                                        const int8_t* fromtags,
                                        int64_t fromtagsoffset,
...
ERROR
awkward_UnionArray64_flatten_length_64(int64_t* total_length,
                                       const int8_t* fromtags,
                                       int64_t fromtagsoffset,
...
template <typename FROMTAGS,
          ...
          typename T>
ERROR
awkward_UnionArray_flatten_combine(TOTAGS* totags,
                                   TOINDEX* toindex,
                                   T* tooffsets,
                                   const FROMTAGS* fromtags,
                                   int64_t fromtagsoffset,
...
ERROR
awkward_UnionArray32_flatten_combine_64(int8_t* totags,
                                        int64_t* toindex,
                                        int64_t* tooffsets,
                                        const int8_t* fromtags,
                                        int64_t fromtagsoffset,
...
ERROR
awkward_UnionArrayU32_flatten_combine_64(int8_t* totags,
                                         int64_t* toindex,
                                         int64_t* tooffsets,
                                         const int8_t* fromtags,
                                         int64_t fromtagsoffset,
...
ERROR
awkward_UnionArray64_flatten_combine_64(int8_t* totags,
                                        int64_t* toindex,
                                        int64_t* tooffsets,
                                        const int8_t* fromtags,
                                        int64_t fromtagsoffset,
...
ERROR
awkward_IndexedArray_flatten_nextcarry(T* tocarry,
                                       const C* fromindex,
                                       int64_t indexoffset,
                                       int64_t lenindex,
                                       int64_t lencontent) {
...
ERROR
awkward_IndexedArray32_flatten_nextcarry_64(int64_t* tocarry,
                                            const int32_t* fromindex,
                                            int64_t indexoffset,
                                            int64_t lenindex,
                                            int64_t lencontent) {
...
ERROR
awkward_IndexedArrayU32_flatten_nextcarry_64(int64_t* tocarry,
                                             const uint32_t* fromindex,
                                             int64_t indexoffset,
                                             int64_t lenindex,
                                             int64_t lencontent) {
...
ERROR
awkward_IndexedArray64_flatten_nextcarry_64(int64_t* tocarry,
                                            const int64_t* fromindex,
                                            int64_t indexoffset,
                                            int64_t lenindex,
                                            int64_t lencontent) {
...
ERROR
awkward_IndexedArray_overlay_mask(TO* toindex,
                                  const M* mask,
                                  int64_t maskoffset,
                                  const C* fromindex,
                                  int64_t indexoffset,
...
ERROR
awkward_IndexedArray32_overlay_mask8_to64(int64_t* toindex,
                                          const int8_t* mask,
                                          int64_t maskoffset,
                                          const int32_t* fromindex,
                                          int64_t indexoffset,
...
ERROR
awkward_IndexedArrayU32_overlay_mask8_to64(int64_t* toindex,
                                           const int8_t* mask,
                                           int64_t maskoffset,
                                           const uint32_t* fromindex,
                                           int64_t indexoffset,
...
ERROR
awkward_IndexedArray64_overlay_mask8_to64(int64_t* toindex,
                                          const int8_t* mask,
                                          int64_t maskoffset,
                                          const int64_t* fromindex,
                                          int64_t indexoffset,
...
ERROR
awkward_IndexedArray_mask(M* tomask,
                          const C* fromindex,
                          int64_t indexoffset,
                          int64_t length) {
  for (int64_t i = 0; i < length; i++) {
...
ERROR
awkward_IndexedArray32_mask8(int8_t* tomask,
                             const int32_t* fromindex,
                             int64_t indexoffset,
                             int64_t length) {
...
ERROR
awkward_IndexedArrayU32_mask8(int8_t* tomask,
                              const uint32_t* fromindex,
                              int64_t indexoffset,
                              int64_t length) {
...
ERROR
awkward_IndexedArray64_mask8(int8_t* tomask,
                             const int64_t* fromindex,
                             int64_t indexoffset,
                             int64_t length) {
...
template <typename M>
ERROR
awkward_ByteMaskedArray_mask(M* tomask,
                             const M* frommask,
                             int64_t maskoffset,
                             int64_t length,
                             bool validwhen) {
...
ERROR
awkward_ByteMaskedArray_mask8(int8_t* tomask,
...
template <typename M>
ERROR
awkward_zero_mask(M* tomask, int64_t length) {
  for (int64_t i = 0; i < length; i++) {
    tomask[i] = 0;
  }
  return success();
...
ERROR
awkward_IndexedArray32_simplify32_to64(int64_t* toindex,
                                       ...
                                       int64_t inneroffset,
                                       int64_t innerlength) {
  return awkward_IndexedArray_simplify<int32_t, int32_t, int64_t>(toindex,
                                                                  outerindex,
                                                                  outeroffset,
                                                                  outerlength,
                                                                  innerindex,
...
ERROR
awkward_IndexedArray32_simplifyU32_to64(int64_t* toindex,
                                        const int32_t* outerindex,
                                        int64_t outeroffset,
                                        int64_t outerlength,
                                        ...
                                        int64_t inneroffset,
                                        int64_t innerlength) {
  return awkward_IndexedArray_simplify<int32_t, uint32_t, int64_t>(toindex,
                                                                   outerindex,
                                                                   outeroffset,
                                                                   outerlength,
                                                                   innerindex,
...
ERROR
awkward_IndexedArray32_simplify64_to64(int64_t* toindex,
                                       const int32_t* outerindex,
                                       int64_t outeroffset,
                                       int64_t outerlength,
                                       ...
                                       int64_t inneroffset,
                                       int64_t innerlength) {
  return awkward_IndexedArray_simplify<int32_t, int64_t, int64_t>(toindex,
                                                                  outerindex,
                                                                  outeroffset,
                                                                  outerlength,
                                                                  innerindex,
...
ERROR
awkward_IndexedArrayU32_simplify32_to64(int64_t* toindex,
                                        ...
                                        int64_t inneroffset,
                                        int64_t innerlength) {
  return awkward_IndexedArray_simplify<uint32_t, int32_t, int64_t>(toindex,
                                                                   outerindex,
                                                                   outeroffset,
                                                                   outerlength,
                                                                   innerindex,
...
ERROR
awkward_IndexedArrayU32_simplifyU32_to64(int64_t* toindex,
                                         const uint32_t* outerindex,
                                         int64_t outeroffset,
                                         int64_t outerlength,
                                         const uint32_t* innerindex,
...
ERROR
awkward_IndexedArrayU32_simplify64_to64(int64_t* toindex,
                                        const uint32_t* outerindex,
                                        int64_t outeroffset,
                                        int64_t outerlength,
                                        const int64_t* innerindex,
                                        int64_t inneroffset,
                                        int64_t innerlength) {
  return awkward_IndexedArray_simplify<uint32_t, int64_t, int64_t>(toindex,
                                                                   outerindex,
                                                                   outeroffset,
                                                                   outerlength,
                                                                   innerindex,
...
ERROR
awkward_IndexedArray64_simplify32_to64(int64_t* toindex,
                                       ...
                                       int64_t inneroffset,
                                       int64_t innerlength) {
  return awkward_IndexedArray_simplify<int64_t, int32_t, int64_t>(toindex,
                                                                  outerindex,
                                                                  outeroffset,
                                                                  outerlength,
                                                                  innerindex,
...
ERROR
awkward_IndexedArray64_simplifyU32_to64(int64_t* toindex,
                                        const int64_t* outerindex,
                                        int64_t outeroffset,
                                        int64_t outerlength,
                                        const uint32_t* innerindex,
                                        int64_t inneroffset,
                                        int64_t innerlength) {
  return awkward_IndexedArray_simplify<int64_t, uint32_t, int64_t>(toindex,
                                                                   outerindex,
                                                                   outeroffset,
                                                                   outerlength,
                                                                   innerindex,
...
ERROR
awkward_IndexedArray64_simplify64_to64(int64_t* toindex,
                                       const int64_t* outerindex,
                                       int64_t outeroffset,
                                       int64_t outerlength,
                                       const int64_t* innerindex,
                                       int64_t inneroffset,
                                       int64_t innerlength) {
  return awkward_IndexedArray_simplify<int64_t, int64_t, int64_t>(toindex,
                                                                  outerindex,
                                                                  outeroffset,
                                                                  outerlength,
                                                                  innerindex,
...
ERROR
awkward_RegularArray_compact_offsets64(int64_t* tooffsets,
                                       int64_t length,
                                       int64_t size) {
...
ERROR
awkward_ListArray32_compact_offsets_64(int64_t* tooffsets,
                                       const int32_t* fromstarts,
                                       const int32_t* fromstops,
                                       int64_t startsoffset,
                                       int64_t stopsoffset,
...
ERROR
awkward_ListArrayU32_compact_offsets_64(int64_t* tooffsets,
                                        const uint32_t* fromstarts,
                                        const uint32_t* fromstops,
                                        int64_t startsoffset,
                                        int64_t stopsoffset,
...
ERROR
awkward_ListArray64_compact_offsets_64(int64_t* tooffsets,
                                       const int64_t* fromstarts,
                                       const int64_t* fromstops,
                                       int64_t startsoffset,
                                       int64_t stopsoffset,
...
ERROR
awkward_ListOffsetArray32_compact_offsets_64(int64_t* tooffsets,
...
ERROR
awkward_ListOffsetArrayU32_compact_offsets_64(int64_t* tooffsets,
...
ERROR
awkward_ListOffsetArray64_compact_offsets_64(int64_t* tooffsets,
...
awkward_ListArray_broadcast_tooffsets(T* tocarry,
  ...
  for (int64_t i = 0; i < offsetslength - 1; i++) {
    ...
    if (count < 0) {
      return failure("broadcast's offsets must be monotonically increasing",
                     i,
                     kSliceNone);
    }
    if (stop - start != count) {
...
ERROR
awkward_ListArray32_broadcast_tooffsets_64(int64_t* tocarry,
                                           const int64_t* fromoffsets,
                                           int64_t offsetsoffset,
                                           int64_t offsetslength,
                                           const int32_t* fromstarts,
                                           ...
                                           int64_t stopsoffset,
                                           int64_t lencontent) {
  return awkward_ListArray_broadcast_tooffsets<int32_t, int64_t>(tocarry,
                                                                 fromoffsets,
                                                                 offsetsoffset,
                                                                 offsetslength,
                                                                 fromstarts,
...
ERROR
awkward_ListArrayU32_broadcast_tooffsets_64(int64_t* tocarry,
                                            const int64_t* fromoffsets,
                                            int64_t offsetsoffset,
                                            int64_t offsetslength,
                                            const uint32_t* fromstarts,
                                            ...
                                            int64_t stopsoffset,
                                            int64_t lencontent) {
  return awkward_ListArray_broadcast_tooffsets<uint32_t, int64_t>(tocarry,
                                                                  fromoffsets,
                                                                  offsetsoffset,
                                                                  offsetslength,
                                                                  fromstarts,
...
ERROR
awkward_ListArray64_broadcast_tooffsets_64(int64_t* tocarry,
                                           const int64_t* fromoffsets,
                                           int64_t offsetsoffset,
                                           int64_t offsetslength,
                                           const int64_t* fromstarts,
                                           ...
                                           int64_t stopsoffset,
                                           int64_t lencontent) {
  return awkward_ListArray_broadcast_tooffsets<int64_t, int64_t>(tocarry,
                                                                 fromoffsets,
                                                                 offsetsoffset,
                                                                 offsetslength,
                                                                 fromstarts,
...
ERROR
awkward_RegularArray_broadcast_tooffsets_64(const int64_t* fromoffsets,
                                            int64_t offsetsoffset,
                                            int64_t offsetslength,
                                            int64_t size) {
...
template <typename T>
ERROR
awkward_RegularArray_broadcast_tooffsets_size1(T* tocarry,
                                               const T* fromoffsets,
                                               int64_t offsetsoffset,
                                               int64_t offsetslength) {
  int64_t k = 0;
...
ERROR
awkward_RegularArray_broadcast_tooffsets_size1_64(int64_t* tocarry,
                                                  const int64_t* fromoffsets,
                                                  int64_t offsetsoffset,
                                                  int64_t offsetslength) {
...
template <typename C>
ERROR
awkward_ListOffsetArray_toRegularArray(int64_t* size,
                                       const C* fromoffsets,
                                       int64_t offsetsoffset,
                                       int64_t offsetslength) {
  *size = -1;
...
ERROR
awkward_ListOffsetArray32_toRegularArray(int64_t* size,
                                         const int32_t* fromoffsets,
                                         int64_t offsetsoffset,
                                         int64_t offsetslength) {
...
ERROR
awkward_ListOffsetArrayU32_toRegularArray(int64_t* size,
                                          const uint32_t* fromoffsets,
                                          int64_t offsetsoffset,
                                          int64_t offsetslength) {
...
ERROR
awkward_ListOffsetArray64_toRegularArray(int64_t* size,
                                         const int64_t* fromoffsets,
                                         int64_t offsetsoffset,
                                         int64_t offsetslength) {
...
template <typename FROM, typename TO>
ERROR
awkward_ListArray_fill(TO* tostarts,
...
ERROR
awkward_ListArray_fill_to64_from32(int64_t* tostarts,
                                   int64_t tostartsoffset,
                                   int64_t* tostops,
                                   int64_t tostopsoffset,
                                   const int32_t* fromstarts,
                                   ...
                                   int64_t length,
                                   int64_t base) {
  return awkward_ListArray_fill<int32_t, int64_t>(tostarts,
                                                  tostartsoffset,
                                                  tostops,
                                                  tostopsoffset,
                                                  fromstarts,
...
ERROR
awkward_ListArray_fill_to64_fromU32(int64_t* tostarts,
                                    int64_t tostartsoffset,
                                    int64_t* tostops,
                                    int64_t tostopsoffset,
                                    const uint32_t* fromstarts,
                                    ...
                                    int64_t length,
                                    int64_t base) {
  return awkward_ListArray_fill<uint32_t, int64_t>(tostarts,
                                                   tostartsoffset,
                                                   tostops,
                                                   tostopsoffset,
                                                   fromstarts,
...
ERROR
awkward_ListArray_fill_to64_from64(int64_t* tostarts,
                                   int64_t tostartsoffset,
                                   int64_t* tostops,
                                   int64_t tostopsoffset,
                                   const int64_t* fromstarts,
                                   ...
                                   int64_t length,
                                   int64_t base) {
  return awkward_ListArray_fill<int64_t, int64_t>(tostarts,
                                                  tostartsoffset,
                                                  tostops,
                                                  tostopsoffset,
                                                  fromstarts,
...
template <typename FROM, typename TO>
ERROR
awkward_IndexedArray_fill(TO* toindex,
...
ERROR
awkward_IndexedArray_fill_to64_from32(int64_t* toindex,
                                      int64_t toindexoffset,
                                      const int32_t* fromindex,
                                      int64_t fromindexoffset,
                                      int64_t length,
...
ERROR
awkward_IndexedArray_fill_to64_fromU32(int64_t* toindex,
                                       int64_t toindexoffset,
                                       const uint32_t* fromindex,
                                       int64_t fromindexoffset,
                                       int64_t length,
...
ERROR
awkward_IndexedArray_fill_to64_from64(int64_t* toindex,
                                      int64_t toindexoffset,
                                      const int64_t* fromindex,
                                      int64_t fromindexoffset,
                                      int64_t length,
...
template <typename TO>
ERROR
awkward_IndexedArray_fill_count(TO* toindex,
                                int64_t toindexoffset,
                                int64_t length,
                                int64_t base) {
  for (int64_t i = 0; i < length; i++) {
...
ERROR
awkward_IndexedArray_fill_to64_count(int64_t* toindex,
                                     int64_t toindexoffset,
                                     int64_t length,
                                     int64_t base) {
...
template <typename FROM, typename TO>
ERROR
awkward_UnionArray_filltags(TO* totags,
...
ERROR
awkward_UnionArray_filltags_to8_from8(int8_t* totags,
                                      int64_t totagsoffset,
                                      const int8_t* fromtags,
                                      int64_t fromtagsoffset,
                                      int64_t length,
...
template <typename FROM, typename TO>
ERROR
awkward_UnionArray_fillindex(TO* toindex,
                             int64_t toindexoffset,
                             const FROM* fromindex,
                             int64_t fromindexoffset,
                             int64_t length) {
...
ERROR
awkward_UnionArray_fillindex_to64_from32(int64_t* toindex,
                                         int64_t toindexoffset,
                                         const int32_t* fromindex,
                                         int64_t fromindexoffset,
                                         int64_t length) {
...
ERROR
awkward_UnionArray_fillindex_to64_fromU32(int64_t* toindex,
                                          int64_t toindexoffset,
                                          const uint32_t* fromindex,
                                          int64_t fromindexoffset,
                                          int64_t length) {
...
ERROR
awkward_UnionArray_fillindex_to64_from64(int64_t* toindex,
                                         int64_t toindexoffset,
                                         const int64_t* fromindex,
                                         int64_t fromindexoffset,
                                         int64_t length) {
...
template <typename TO>
ERROR
awkward_UnionArray_filltags_const(TO* totags,
                                  int64_t totagsoffset,
                                  int64_t length,
                                  int64_t base) {
  for (int64_t i = 0; i < length; i++) {
...
ERROR
awkward_UnionArray_filltags_to8_const(int8_t* totags,
                                      int64_t totagsoffset,
                                      int64_t length,
                                      int64_t base) {
...
template <typename TO>
ERROR
awkward_UnionArray_fillindex_count(TO* toindex,
                                   int64_t toindexoffset,
                                   int64_t length) {
  for (int64_t i = 0; i < length; i++) {
...
ERROR
awkward_UnionArray_fillindex_to64_count(int64_t* toindex,
                                        int64_t toindexoffset,
                                        int64_t length) {
...
template <typename OUTERTAGS,
          ...
          typename TOINDEX>
ERROR
awkward_UnionArray_simplify(TOTAGS* totags,
                            TOINDEX* toindex,
...
ERROR
awkward_UnionArray8_32_simplify8_32_to8_64(int8_t* totags,
                                           int64_t* toindex,
...
ERROR
awkward_UnionArray8_32_simplify8_U32_to8_64(int8_t* totags,
                                            int64_t* toindex,
                                            const int8_t* outertags,
                                            int64_t outertagsoffset,
                                            const int32_t* outerindex,
...
ERROR
awkward_UnionArray8_32_simplify8_64_to8_64(int8_t* totags,
                                           int64_t* toindex,
                                           const int8_t* outertags,
                                           int64_t outertagsoffset,
                                           const int32_t* outerindex,
...
ERROR
awkward_UnionArray8_U32_simplify8_32_to8_64(int8_t* totags,
                                            int64_t* toindex,
                                            const int8_t* outertags,
                                            int64_t outertagsoffset,
                                            const uint32_t* outerindex,
...
ERROR
awkward_UnionArray8_U32_simplify8_U32_to8_64(int8_t* totags,
                                             int64_t* toindex,
                                             const int8_t* outertags,
                                             int64_t outertagsoffset,
                                             const uint32_t* outerindex,
...
ERROR
awkward_UnionArray8_U32_simplify8_64_to8_64(int8_t* totags,
                                            int64_t* toindex,
                                            const int8_t* outertags,
                                            int64_t outertagsoffset,
                                            const uint32_t* outerindex,
...
ERROR
awkward_UnionArray8_64_simplify8_32_to8_64(int8_t* totags,
                                           int64_t* toindex,
                                           const int8_t* outertags,
                                           int64_t outertagsoffset,
                                           const int64_t* outerindex,
...
ERROR
awkward_UnionArray8_64_simplify8_U32_to8_64(int8_t* totags,
                                            int64_t* toindex,
                                            const int8_t* outertags,
                                            int64_t outertagsoffset,
                                            const int64_t* outerindex,
...
ERROR
awkward_UnionArray8_64_simplify8_64_to8_64(int8_t* totags,
                                           int64_t* toindex,
                                           const int8_t* outertags,
                                           int64_t outertagsoffset,
                                           const int64_t* outerindex,
...
ERROR
awkward_UnionArray_simplify_one(TOTAGS* totags,
                                TOINDEX* toindex,
                                const FROMTAGS* fromtags,
                                int64_t fromtagsoffset,
                                const FROMINDEX* fromindex,
...
ERROR
awkward_UnionArray8_32_simplify_one_to8_64(int8_t* totags,
                                           int64_t* toindex,
                                           const int8_t* fromtags,
                                           int64_t fromtagsoffset,
                                           const int32_t* fromindex,
...
ERROR
awkward_UnionArray8_U32_simplify_one_to8_64(int8_t* totags,
                                            int64_t* toindex,
                                            const int8_t* fromtags,
                                            int64_t fromtagsoffset,
                                            const uint32_t* fromindex,
...
ERROR
awkward_UnionArray8_64_simplify_one_to8_64(int8_t* totags,
                                           int64_t* toindex,
                                           const int8_t* fromtags,
                                           int64_t fromtagsoffset,
                                           const int64_t* fromindex,
...
ERROR
awkward_ListArray32_validity(const int32_t* starts,
                             int64_t startsoffset,
                             const int32_t* stops,
                             int64_t stopsoffset,
                             int64_t length,
...
ERROR
awkward_ListArrayU32_validity(const uint32_t* starts,
                              int64_t startsoffset,
...
ERROR
awkward_ListArray64_validity(const int64_t* starts,
                             int64_t startsoffset,
                             const int64_t* stops,
                             int64_t stopsoffset,
                             int64_t length,
...
ERROR
awkward_IndexedArray_validity(const C* index,
                              int64_t indexoffset,
                              int64_t length,
                              int64_t lencontent) {
  for (int64_t i = 0; i < length; i++) {
...
ERROR
awkward_IndexedArray32_validity(const int32_t* index,
                                int64_t indexoffset,
                                int64_t length,
                                int64_t lencontent,
                                bool isoption) {
  if (isoption) {
    return awkward_IndexedArray_validity<int32_t, true>(
        index, indexoffset, length, lencontent);
  } else {
...
ERROR
awkward_IndexedArrayU32_validity(const uint32_t* index,
                                 int64_t indexoffset,
                                 int64_t length,
                                 int64_t lencontent,
                                 bool isoption) {
...
ERROR
awkward_IndexedArray64_validity(const int64_t* index,
                                int64_t indexoffset,
                                int64_t length,
                                int64_t lencontent,
                                bool isoption) {
...
ERROR
awkward_UnionArray8_32_validity(const int8_t* tags,
                                int64_t tagsoffset,
                                const int32_t* index,
                                int64_t indexoffset,
                                int64_t length,
...
ERROR
awkward_UnionArray8_U32_validity(const int8_t* tags,
                                 int64_t tagsoffset,
...
ERROR
awkward_UnionArray8_64_validity(const int8_t* tags,
                                int64_t tagsoffset,
                                const int64_t* index,
                                int64_t indexoffset,
                                int64_t length,
...
ERROR
awkward_UnionArray_fillna_from32_to64(int64_t* toindex,
                                      const int32_t* fromindex,
                                      int64_t offset,
                                      int64_t length) {
...
ERROR
awkward_UnionArray_fillna_fromU32_to64(int64_t* toindex,
                                       const uint32_t* fromindex,
                                       int64_t offset,
                                       int64_t length) {
...
ERROR
awkward_UnionArray_fillna_from64_to64(int64_t* toindex,
                                      const int64_t* fromindex,
                                      int64_t offset,
                                      int64_t length) {
...
template <typename T>
ERROR
awkward_IndexedOptionArray_rpad_and_clip_mask_axis1(T* toindex,
                                                    const int8_t* frommask,
                                                    int64_t length) {
  int64_t count = 0;
  for (int64_t i = 0; i < length; i++) {
...
ERROR
awkward_IndexedOptionArray_rpad_and_clip_mask_axis1_64(int64_t* toindex,
                                                       const int8_t* frommask,
                                                       int64_t length) {
...
template <typename T>
ERROR
awkward_index_rpad_and_clip_axis0(T* toindex, int64_t target, int64_t length) {
...
ERROR
awkward_index_rpad_and_clip_axis0_64(int64_t* toindex,
                                     int64_t target,
                                     int64_t length) {
...
ERROR
awkward_index_rpad_and_clip_axis1_64(int64_t* tostarts,
                                     int64_t* tostops,
                                     int64_t target,
                                     int64_t length) {
...
template <typename T>
ERROR
awkward_RegularArray_rpad_and_clip_axis1(T* toindex,
                                         int64_t target,
                                         int64_t size,
                                         int64_t length) {
...
ERROR
awkward_RegularArray_rpad_and_clip_axis1_64(int64_t* toindex,
                                            int64_t target,
                                            int64_t size,
                                            int64_t length) {
...
template <typename C>
ERROR
awkward_ListArray_min_range(int64_t* tomin,
                            const C* fromstarts,
                            const C* fromstops,
                            int64_t lenstarts,
                            int64_t startsoffset,
...
ERROR
awkward_ListArray32_min_range(int64_t* tomin,
                              const int32_t* fromstarts,
                              const int32_t* fromstops,
                              int64_t lenstarts,
                              int64_t startsoffset,
...
ERROR
awkward_ListArrayU32_min_range(int64_t* tomin,
                               const uint32_t* fromstarts,
                               const uint32_t* fromstops,
                               int64_t lenstarts,
                               int64_t startsoffset,
...
ERROR
awkward_ListArray64_min_range(int64_t* tomin,
                              const int64_t* fromstarts,
                              const int64_t* fromstops,
                              int64_t lenstarts,
                              int64_t startsoffset,
...
template <typename C>
ERROR
awkward_ListArray_rpad_and_clip_length_axis1(int64_t* tolength,
                                             const C* fromstarts,
                                             const C* fromstops,
                                             int64_t target,
                                             int64_t lenstarts,
...
ERROR
awkward_ListArray32_rpad_and_clip_length_axis1(int64_t* tomin,
                                               const int32_t* fromstarts,
                                               const int32_t* fromstops,
                                               int64_t target,
                                               int64_t lenstarts,
                                               int64_t startsoffset,
                                               int64_t stopsoffset) {
  return awkward_ListArray_rpad_and_clip_length_axis1<int32_t>(tomin,
                                                               fromstarts,
                                                               fromstops,
                                                               target,
                                                               lenstarts,
...
ERROR
awkward_ListArrayU32_rpad_and_clip_length_axis1(int64_t* tomin,
                                                const uint32_t* fromstarts,
                                                const uint32_t* fromstops,
                                                int64_t target,
                                                int64_t lenstarts,
                                                int64_t startsoffset,
                                                int64_t stopsoffset) {
  return awkward_ListArray_rpad_and_clip_length_axis1<uint32_t>(tomin,
                                                                fromstarts,
                                                                fromstops,
                                                                target,
                                                                lenstarts,
...
ERROR
awkward_ListArray64_rpad_and_clip_length_axis1(int64_t* tomin,
                                               const int64_t* fromstarts,
                                               const int64_t* fromstops,
                                               int64_t target,
                                               int64_t lenstarts,
                                               int64_t startsoffset,
                                               int64_t stopsoffset) {
  return awkward_ListArray_rpad_and_clip_length_axis1<int64_t>(tomin,
                                                               fromstarts,
                                                               fromstops,
                                                               target,
                                                               lenstarts,
...
template <typename T, typename C>
ERROR
awkward_ListArray_rpad_axis1(T* toindex,
                             const C* fromstarts,
                             const C* fromstops,
                             C* tostarts,
                             C* tostops,
  ...
  for (int64_t i = 0; i < length; i++) {
    ...
    offset =
        (target > rangeval) ? tostarts[i] + target : tostarts[i] + rangeval;
    tostops[i] = offset;
  }
  return success();
}
ERROR
awkward_ListArray32_rpad_axis1_64(int64_t* toindex,
                                  const int32_t* fromstarts,
                                  const int32_t* fromstops,
                                  int32_t* tostarts,
                                  int32_t* tostops,
                                  ...
                                  int64_t startsoffset,
                                  int64_t stopsoffset) {
  return awkward_ListArray_rpad_axis1<int64_t, int32_t>(toindex,
                                                        fromstarts,
                                                        fromstops,
                                                        tostarts,
                                                        tostops,
...
ERROR
awkward_ListArrayU32_rpad_axis1_64(int64_t* toindex,
                                   const uint32_t* fromstarts,
                                   const uint32_t* fromstops,
                                   uint32_t* tostarts,
                                   uint32_t* tostops,
                                   ...
                                   int64_t startsoffset,
                                   int64_t stopsoffset) {
  return awkward_ListArray_rpad_axis1<int64_t, uint32_t>(toindex,
                                                         fromstarts,
                                                         fromstops,
                                                         tostarts,
                                                         tostops,
...
ERROR
awkward_ListArray64_rpad_axis1_64(int64_t* toindex,
                                  const int64_t* fromstarts,
                                  const int64_t* fromstops,
                                  int64_t* tostarts,
                                  int64_t* tostops,
                                  ...
                                  int64_t startsoffset,
                                  int64_t stopsoffset) {
  return awkward_ListArray_rpad_axis1<int64_t, int64_t>(toindex,
                                                        fromstarts,
                                                        fromstops,
                                                        tostarts,
                                                        tostops,
...
ERROR
awkward_ListOffsetArray32_rpad_and_clip_axis1_64(int64_t* toindex,
                                                 const int32_t* fromoffsets,
                                                 int64_t offsetsoffset,
                                                 int64_t length,
                                                 int64_t target) {
...
ERROR
awkward_ListOffsetArrayU32_rpad_and_clip_axis1_64(int64_t* toindex,
                                                  const uint32_t* fromoffsets,
                                                  int64_t offsetsoffset,
                                                  int64_t length,
                                                  int64_t target) {
...
ERROR
awkward_ListOffsetArray64_rpad_and_clip_axis1_64(int64_t* toindex,
                                                 const int64_t* fromoffsets,
                                                 int64_t offsetsoffset,
                                                 int64_t length,
                                                 int64_t target) {
...
template <typename C>
ERROR
awkward_ListOffsetArray_rpad_length_axis1(C* tooffsets,
                                          const C* fromoffsets,
                                          int64_t offsetsoffset,
                                          int64_t fromlength,
                                          int64_t target,
...
ERROR
awkward_ListOffsetArray32_rpad_length_axis1(int32_t* tooffsets,
                                            const int32_t* fromoffsets,
                                            int64_t offsetsoffset,
                                            int64_t fromlength,
                                            int64_t target,
...
ERROR
awkward_ListOffsetArrayU32_rpad_length_axis1(uint32_t* tooffsets,
                                             const uint32_t* fromoffsets,
                                             int64_t offsetsoffset,
                                             int64_t fromlength,
                                             int64_t target,
...
ERROR
awkward_ListOffsetArray64_rpad_length_axis1(int64_t* tooffsets,
                                            const int64_t* fromoffsets,
                                            int64_t offsetsoffset,
                                            int64_t fromlength,
                                            int64_t target,
...
ERROR
awkward_ListOffsetArray32_rpad_axis1_64(int64_t* toindex,
                                        const int32_t* fromoffsets,
                                        int64_t offsetsoffset,
                                        int64_t fromlength,
                                        int64_t target) {
...
ERROR
awkward_ListOffsetArrayU32_rpad_axis1_64(int64_t* toindex,
                                         const uint32_t* fromoffsets,
                                         int64_t offsetsoffset,
                                         int64_t fromlength,
                                         int64_t target) {
...
ERROR
awkward_ListOffsetArray64_rpad_axis1_64(int64_t* toindex,
                                        const int64_t* fromoffsets,
                                        int64_t offsetsoffset,
                                        int64_t fromlength,
                                        int64_t target) {
...
template <typename T>
ERROR
awkward_localindex(T* toindex, int64_t length) {
  for (int64_t i = 0; i < length; i++) {
    toindex[i] = i;
  }
  return success();
...
ERROR
awkward_localindex_64(int64_t* toindex, int64_t length) {
  return awkward_localindex<int64_t>(toindex, length);
}

template <typename C, typename T>
ERROR
awkward_ListArray_localindex(T* toindex,
                             const C* offsets,
                             int64_t offsetsoffset,
                             int64_t length) {
  for (int64_t i = 0; i < length; i++) {
...
ERROR
awkward_ListArray32_localindex_64(int64_t* toindex,
...
ERROR
awkward_ListArrayU32_localindex_64(int64_t* toindex,
...
ERROR
awkward_ListArray64_localindex_64(int64_t* toindex,
                                  const int64_t* offsets,
                                  int64_t offsetsoffset,
                                  int64_t length) {
...
template <typename T>
ERROR
awkward_RegularArray_localindex(T* toindex, int64_t size, int64_t length) {
  for (int64_t i = 0; i < length; i++) {
...
ERROR
awkward_RegularArray_localindex_64(int64_t* toindex,
                                   int64_t size,
                                   int64_t length) {
...
ERROR
awkward_combinations_64(int64_t* toindex,
                        int64_t n,
                        bool replacement,
                        int64_t singlelen) {
  return awkward_combinations<int64_t>(toindex, n, replacement, singlelen);
}

template <typename C, typename T>
ERROR
awkward_ListArray_combinations_length(int64_t* totallen,
                                      T* tooffsets,
                                      int64_t n,
                                      bool replacement,
                                      const C* starts,
...
ERROR
awkward_ListArray32_combinations_length_64(int64_t* totallen,
                                           int64_t* tooffsets,
                                           int64_t n,
                                           bool replacement,
                                           ...
                                           int64_t stopsoffset,
                                           int64_t length) {
  return awkward_ListArray_combinations_length<int32_t, int64_t>(totallen,
                                                                 tooffsets,
                                                                 n,
                                                                 replacement,
                                                                 starts,
...
ERROR
awkward_ListArrayU32_combinations_length_64(int64_t* totallen,
                                            int64_t* tooffsets,
                                            int64_t n,
                                            bool replacement,
                                            ...
                                            int64_t stopsoffset,
                                            int64_t length) {
  return awkward_ListArray_combinations_length<uint32_t, int64_t>(totallen,
                                                                  tooffsets,
                                                                  n,
                                                                  replacement,
                                                                  starts,
...
ERROR
awkward_ListArray64_combinations_length_64(int64_t* totallen,
                                           int64_t* tooffsets,
                                           int64_t n,
                                           bool replacement,
                                           ...
                                           int64_t stopsoffset,
                                           int64_t length) {
  return awkward_ListArray_combinations_length<int64_t, int64_t>(totallen,
                                                                 tooffsets,
                                                                 n,
                                                                 replacement,
                                                                 starts,
  ...
  while (fromindex[j] < stop) {
    ...
    if (j + 1 == n) {
      ...
      awkward_ListArray_combinations_step<T>(
          tocarry, toindex, fromindex, j + 1, stop, n, replacement);
    }
    fromindex[j]++;
  }
}
...
template <typename C, typename T>
ERROR
awkward_ListArray_combinations(T** tocarry,
                               int64_t* toindex,
                               int64_t* fromindex,
                               int64_t n,
                               bool replacement,
...
ERROR
awkward_ListArray32_combinations_64(int64_t** tocarry,
                                    int64_t* toindex,
                                    int64_t* fromindex,
                                    int64_t n,
                                    bool replacement,
                                    ...
                                    int64_t stopsoffset,
                                    int64_t length) {
  return awkward_ListArray_combinations<int32_t, int64_t>(tocarry,
                                                          toindex,
                                                          fromindex,
                                                          n,
                                                          replacement,
...
ERROR
awkward_ListArrayU32_combinations_64(int64_t** tocarry,
                                     int64_t* toindex,
                                     int64_t* fromindex,
                                     int64_t n,
                                     bool replacement,
                                     ...
                                     int64_t stopsoffset,
                                     int64_t length) {
  return awkward_ListArray_combinations<uint32_t, int64_t>(tocarry,
                                                           toindex,
                                                           fromindex,
                                                           n,
                                                           replacement,
...
ERROR
awkward_ListArray64_combinations_64(int64_t** tocarry,
                                    int64_t* toindex,
                                    int64_t* fromindex,
                                    int64_t n,
                                    bool replacement,
                                    ...
                                    int64_t stopsoffset,
                                    int64_t length) {
  return awkward_ListArray_combinations<int64_t, int64_t>(tocarry,
                                                          toindex,
                                                          fromindex,
                                                          n,
                                                          replacement,
...
template <typename C, typename T>
ERROR
awkward_RegularArray_combinations(T** tocarry,
                                  int64_t* toindex,
                                  int64_t* fromindex,
                                  int64_t n,
                                  bool replacement,
...
ERROR
awkward_RegularArray_combinations_64(int64_t** tocarry,
                                     int64_t* toindex,
                                     int64_t* fromindex,
                                     int64_t n,
                                     bool replacement,
...
template <typename M>
ERROR
awkward_ByteMaskedArray_overlay_mask(M* tomask,
                                     const M* theirmask,
...
ERROR
awkward_ByteMaskedArray_overlay_mask8(int8_t* tomask,
                                      ...
                                      int64_t length,
                                      bool validwhen) {
  return awkward_ByteMaskedArray_overlay_mask<int8_t>(tomask,
                                                      theirmask,
                                                      theirmaskoffset,
                                                      mymask,
                                                      mymaskoffset,
