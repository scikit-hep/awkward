...
template <typename C, typename T>
ERROR awkward_listarray_transform_starts_stops(C* tostarts, C* tostops, const T* scale, const C* fromstarts, const C* fromstops,  int64_t lenstarts, int64_t startsoffset, int64_t stopsoffset, int64_t lenscale) {
  for (int64_t i = 0; i < lenstarts; i++) {
    int64_t start = (C)fromstarts[startsoffset + i];
    int64_t stop = (C)fromstops[stopsoffset + i];
    if (start < 0  ||  stop < 0) {
    ...
    if (lenscale != lenstarts) {
      return failure("scale index length must be equal to start and stop lenght", kSliceNone, i);
    }
...
ERROR awkward_listarray32_transform_starts_stops_64(int32_t* tostarts, int32_t* tostops, const int64_t* scale, const int32_t* fromstarts, const int32_t* fromstops, int64_t lenstarts, int64_t startsoffset, int64_t stopsoffset, int64_t lenscale) {
  return awkward_listarray_transform_starts_stops<int32_t, int64_t>(tostarts, tostops, scale, fromstarts, fromstops, lenstarts, startsoffset, stopsoffset, lenscale);
}
ERROR awkward_listarrayU32_transform_starts_stops_64(uint32_t* tostarts, uint32_t* tostops, const int64_t* scale, const uint32_t* fromstarts, const uint32_t* fromstops, int64_t lenstarts, int64_t startsoffset, int64_t stopsoffset, int64_t lenscale) {
  return awkward_listarray_transform_starts_stops<uint32_t, int64_t>(tostarts, tostops, scale, fromstarts, fromstops, lenstarts, startsoffset, stopsoffset, lenscale);
}
ERROR awkward_listarray64_transform_starts_stops_64(int64_t* tostarts, int64_t* tostops, const int64_t* scale, const int64_t* fromstarts, const int64_t* fromstops, int64_t lenstarts, int64_t startsoffset, int64_t stopsoffset, int64_t lenscale) {
  return awkward_listarray_transform_starts_stops<int64_t, int64_t>(tostarts, tostops, scale, fromstarts, fromstops, lenstarts, startsoffset, stopsoffset, lenscale);
}
