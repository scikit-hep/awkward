...
//     dtype=cupy.int64)
//     cuda_kernel_templates.get_function(fetch_specialization(["awkward_IndexedArray_reduce_next_64_a",
//     nextcarry.dtype, nextparents.dtype, outindex.dtype, index.dtype,
//     parents.dtype]))(grid, block, (nextcarry, nextparents, outindex, index,
//     parents, length, invocation_index, err_code)) scan_in_array =
//     inclusive_scan(grid, block, (scan_in_array, invocation_index, err_code))
//     cuda_kernel_templates.get_function(fetch_specialization(["awkward_IndexedArray_reduce_next_64_b",
//     nextcarry.dtype, nextparents.dtype, outindex.dtype, index.dtype,
//     parents.dtype]))(grid, block, (nextcarry, nextparents, outindex, index,
//     parents, length, invocation_index, err_code))
