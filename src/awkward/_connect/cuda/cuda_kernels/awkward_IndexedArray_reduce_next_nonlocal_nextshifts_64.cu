...
//     cuda_kernel_templates.get_function(fetch_specialization(["awkward_IndexedArray_reduce_next_nonlocal_nextshifts_64_a",
//     nextshifts.dtype, index.dtype]))(grid, block, (nextshifts, index, length,
//     scan_in_array_k, scan_in_array_nullsum, invocation_index, err_code))
//     scan_in_array_k = inclusive_scan(grid, block, (scan_in_array,
//     invocation_index, err_code)) scan_in_array_nullsum = inclusive_scan(grid,
//     block, (scan_in_array, invocation_index, err_code))
//     cuda_kernel_templates.get_function(fetch_specialization(["awkward_IndexedArray_reduce_next_nonlocal_nextshifts_64_b",
//     nextshifts.dtype, index.dtype]))(grid, block, (nextshifts, index, length,
//     scan_in_array_k, scan_in_array_nullsum, invocation_index, err_code))
// out["awkward_IndexedArray_reduce_next_nonlocal_nextshifts_64_a",
