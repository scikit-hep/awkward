...
//     nextshifts.dtype, mask.dtype]))(grid, block, (nextshifts, mask, length,
//     valid_when, scan_in_array_k, scan_in_array_nullsum, invocation_index,
//     err_code)) scan_in_array_k = inclusive_scan(grid, block,
//     (scan_in_array_k, invocation_index, err_code)) scan_in_array_nullsum =
//     inclusive_scan(grid, block, (scan_in_array_nullsum, invocation_index,
//     err_code))
//     cuda_kernel_templates.get_function(fetch_specialization(["awkward_ByteMaskedArray_reduce_next_nonlocal_nextshifts_64_a",
//     nextshifts.dtype, mask.dtype]))(grid, block, (nextshifts, mask, length,
//     valid_when, scan_in_array_k, scan_in_array_nullsum, invocation_index,
//     err_code))
// out["awkward_ByteMaskedArray_reduce_next_nonlocal_nextshifts_64_a",
// {dtype_specializations}] = None
// out["awkward_ByteMaskedArray_reduce_next_nonlocal_nextshifts_64_b",
