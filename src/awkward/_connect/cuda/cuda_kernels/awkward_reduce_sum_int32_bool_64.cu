...
//     fromptr, parents, lenparents, outlength, atomicAdd_toptr,
//     invocation_index, err_code))
//     cuda_kernel_templates.get_function(fetch_specialization(["awkward_reduce_sum_int32_bool_64_c",
//     toptr.dtype, fromptr.dtype, parents.dtype]))(grid, block, (toptr,
//     fromptr, parents, lenparents, outlength, atomicAdd_toptr,
//     invocation_index, err_code))
...
__global__ void awkward_reduce_sum_int32_bool_64_a(
...
template <typename T, typename C, typename U>
__global__ void awkward_reduce_sum_int32_bool_64_b(
    T *toptr, const C *fromptr, const U *parents, int64_t lenparents,
    int64_t outlength, uint64_t *atomicAdd_toptr, uint64_t invocation_index,
    uint64_t *err_code) {
  if (err_code[0] == NO_ERROR) {
...
template <typename T, typename C, typename U>
__global__ void awkward_reduce_sum_int32_bool_64_c(
    T *toptr, const C *fromptr, const U *parents, int64_t lenparents,
    int64_t outlength, uint64_t *atomicAdd_toptr, uint64_t invocation_index,
    uint64_t *err_code) {
  if (err_code[0] == NO_ERROR) {
