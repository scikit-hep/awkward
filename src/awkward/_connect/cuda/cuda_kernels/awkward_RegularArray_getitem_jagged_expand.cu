...
__global__ void awkward_RegularArray_getitem_jagged_expand(
    T *multistarts, C *multistops, const U *singleoffsets, int64_t regularsize,
    int64_t regularlength, uint64_t invocation_index, uint64_t *err_code) {
