...
__global__ void awkward_IndexedArray_simplify(
    T *toindex, const C *outerindex, int64_t outerlength, const U *innerindex,
    int64_t innerlength, uint64_t invocation_index, uint64_t *err_code) {
