...
//         cuda_kernel_templates.get_function(fetch_specialization(['inclusive_scan_kernel',
//         cupy.int64]))(grid, block, (d_in, d_out, d_final, curr_step,
//         total_steps, stride, in_out_flag, len(d_in), invocation_index,
//         err_code)) stride = stride * 2
//     return d_final
