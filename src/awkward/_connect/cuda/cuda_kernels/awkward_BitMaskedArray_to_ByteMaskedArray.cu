...
__global__ void awkward_BitMaskedArray_to_ByteMaskedArray(
    T *tobytemask, const C *frombitmask, int64_t bitmasklength, bool validwhen,
    bool lsb_order, uint64_t invocation_index, uint64_t *err_code) {
