...
//     cuda_kernel_templates.get_function(fetch_specialization(["awkward_reduce_sum_a",
...
//     cuda_kernel_templates.get_function(fetch_specialization(["awkward_reduce_sum_b",
//     toptr.dtype, fromptr.dtype, parents.dtype]))(grid, block, (toptr,
//     fromptr, parents, lenparents, outlength, atomicAdd_toptr,
//     invocation_index, err_code))
//     cuda_kernel_templates.get_function(fetch_specialization(["awkward_reduce_sum_c",
//     toptr.dtype, fromptr.dtype, parents.dtype]))(grid, block, (toptr,
//     fromptr, parents, lenparents, outlength, atomicAdd_toptr,
//     invocation_index, err_code))
