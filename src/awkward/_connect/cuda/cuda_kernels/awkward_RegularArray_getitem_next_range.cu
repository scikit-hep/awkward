...
template <typename T>
__global__ void awkward_RegularArray_getitem_next_range(
    T *tocarry, int64_t regular_start, int64_t step, int64_t length,
    int64_t size, int64_t nextsize, uint64_t invocation_index,
    uint64_t *err_code) {
