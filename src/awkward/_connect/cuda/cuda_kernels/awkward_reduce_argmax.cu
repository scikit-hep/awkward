...
//     cuda_kernel_templates.get_function(fetch_specialization(["awkward_reduce_argmax_a",
//     toptr.dtype, fromptr.dtype, parents.dtype]))(grid, block, (toptr,
//     fromptr, parents, lenparents,outlength, invocation_index,err_code))
//     cuda_kernel_templates.get_function(fetch_specialization(["awkward_reduce_argmax_b",
//     toptr.dtype, fromptr.dtype, parents.dtype]))(grid, block, (toptr,
//     fromptr, parents, lenparents,outlength, invocation_index,err_code))
