...
__global__ void awkward_RegularArray_getitem_next_array(
    T *tocarry, C *toadvanced, const U *fromarray, int64_t length,
    int64_t lenarray, int64_t size, uint64_t invocation_index,
    uint64_t *err_code) {
