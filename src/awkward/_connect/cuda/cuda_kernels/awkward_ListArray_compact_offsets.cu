...
//     (tooffsets, fromstarts, fromstops, length, invocation_index, err_code) =
//     args
//     cuda_kernel_templates.get_function(fetch_specialization(["awkward_ListArray_compact_offsets_a",
//     tooffsets.dtype, fromstarts.dtype, fromstops.dtype]))(grid, block,
//     (tooffsets, fromstarts, fromstops, length, invocation_index, err_code))
//     tooffsets = inclusive_scan(grid, block, (tooffsets, invocation_index,
//     err_code))
