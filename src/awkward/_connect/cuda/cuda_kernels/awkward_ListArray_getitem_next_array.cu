...
__global__ void awkward_ListArray_getitem_next_array(
    T *tocarry, C *toadvanced, const U *fromstarts, const V *fromstops,
    const W *fromarray, int64_t lenstarts, int64_t lenarray, int64_t lencontent,
