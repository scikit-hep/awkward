...
def fill_none(array, value, axis=-1, *, highlevel=True, behavior=None, attrs=None):
    ...
    Args:
        ...
        axis (None or int or str): If None, replace all None values in the
           ...
           the innermost: `-1` is the innermost dimension, `-2` is the next
           level up, etc; if a str, it is interpreted as the name of the
           axis which maps to an int if named axes are present.
