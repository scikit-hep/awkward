...
def to_packed(array, *, highlevel=True, behavior=None, attrs=None):
    ...
    Returns an array with the same type and values as the input and all the virtual buffers
    materialized (see #ak.materialize), but with packed inner structures:
