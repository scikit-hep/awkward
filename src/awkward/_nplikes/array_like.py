...
class ArrayLike(Protocol):
    ...
    # Scalar UFUNCS
    @abstractmethod
    def __add__(self, other: complex | Self) -> Self: ...

    @abstractmethod
    def __sub__(self, other: complex | Self) -> Self: ...

    @abstractmethod
    def __mul__(self, other: complex | Self) -> Self: ...

    @abstractmethod
    def __truediv__(self, other: complex | Self) -> Self: ...

    @abstractmethod
    def __floordiv__(self, other: complex | Self) -> Self: ...

    @abstractmethod
    def __gt__(self, other: complex | Self) -> Self: ...

    @abstractmethod
    def __lt__(self, other: complex | Self) -> Self: ...

    @abstractmethod
    def __ge__(self, other: complex | Self) -> Self: ...

    @abstractmethod
    def __le__(self, other: complex | Self) -> Self: ...

    @abstractmethod
    def __eq__(self, other: complex | bool | Self) -> Self:  # type: ignore[override]
        ...
