...
namespace awkward {
  ...
  template <typename T, typename I>
  void
  ListOffsetArrayBuilder<T, I>::boolean(bool x, LayoutBuilder<T, I>* builder) {
    content_.get()->boolean(x, builder);
  }

  template <typename T, typename I>
  void
  ListOffsetArrayBuilder<T, I>::int64(int64_t x, LayoutBuilder<T, I>* builder) {
    content_.get()->int64(x, builder);
  }

  template <typename T, typename I>
  void
  ListOffsetArrayBuilder<T, I>::float64(double x, LayoutBuilder<T, I>* builder) {
    content_.get()->float64(x, builder);
  }

  template <typename T, typename I>
  void
  ListOffsetArrayBuilder<T, I>::complex(std::complex<double> x, LayoutBuilder<T, I>* builder) {
    content_.get()->complex(x, builder);
  }

  template <typename T, typename I>
  void
  ListOffsetArrayBuilder<T, I>::bytestring(const std::string& x, LayoutBuilder<T, I>* builder) {
  ...
  template <typename T, typename I>
  void
  ListOffsetArrayBuilder<T, I>::string(const std::string& x, LayoutBuilder<T, I>* builder) {
    if (is_string_builder_) {
      builder->add_string(x);
    }
    else {
  ...
  template <typename T, typename I>
  void
  ListOffsetArrayBuilder<T, I>::begin_list(LayoutBuilder<T, I>* builder) {
    if (!begun_) {
      begun_ = true;
  ...
  template <typename T, typename I>
  void
  ListOffsetArrayBuilder<T, I>::end_list(LayoutBuilder<T, I>* builder) {
    if (!begun_) {
