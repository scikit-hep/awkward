  ...
  /////////////////////////////////// awkward/kernels/getitem.h
    ...
    ERROR RegularArray_merge_offsets_64(
      ...
      if (ptr_lib == kernel::lib::cpu) {
        ...
        CREATE_KERNEL(awkward_RegularArray_merge_offsets64, ptr_lib);
        return (*awkward_RegularArray_merge_offsets64_fcn)(
          tooffsets,
          tolength,
          length,
          size,
        ...
        throw std::runtime_error(
          std::string("unrecognized ptr_lib for RegularArray_merge_offsets_64")
          + FILENAME(__LINE__));
      }
    }
    ...
    ERROR RegularArray_merge_tags_8_index_64(
      ...
      if (ptr_lib == kernel::lib::cpu) {
        ...
        CREATE_KERNEL(awkward_RegularArray_merge_tags8_index64, ptr_lib);
        return (*awkward_RegularArray_merge_tags8_index64_fcn)(
          totags,
          toindex,
          tolength,
          length,
        ...
        throw std::runtime_error(
          std::string("unrecognized ptr_lib for RegularArray_merge_tags_8_index_64")
          + FILENAME(__LINE__));
      }
    }
    ...
    ERROR ListOffsetArray_merge_offsets_64(
      ...
      if (ptr_lib == kernel::lib::cpu) {
        ...
        throw std::runtime_error(
          std::string("not implemented: ptr_lib == cuda_kernels for ListOffsetArray_merge_offsets_64")
          + FILENAME(__LINE__));
      }
      else {
        throw std::runtime_error(
          std::string("unrecognized ptr_lib for ListOffsetArray_merge_offsets_64")
          + FILENAME(__LINE__));
      }
    }
    ...
    ERROR UnionArray_mergetags_to8_const(
      ...
      if (ptr_lib == kernel::lib::cpu) {
        ...
        throw std::runtime_error(
          std::string("not implemented: ptr_lib == cuda_kernels for UnionArray_mergetags_to8_const")
          + FILENAME(__LINE__));
      }
      else {
        throw std::runtime_error(
          std::string("unrecognized ptr_lib for UnionArray_mergetags_to8_const")
          + FILENAME(__LINE__));
      }
    }
