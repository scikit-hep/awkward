...
/////////////////////////////////// awkward/cpu-kernels/getitem.h
  ...
  template<> ERROR NumpyArray_fill<bool, bool>( bool *toptr, int64_t tooffset, const bool *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tobool_frombool( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<bool, int8_t>( int8_t *toptr, int64_t tooffset, const bool *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint8_frombool( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<bool, int16_t>( int16_t *toptr, int64_t tooffset, const bool *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint16_frombool( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<bool, int32_t>( int32_t *toptr, int64_t tooffset, const bool *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint32_frombool( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<bool, int64_t>( int64_t *toptr, int64_t tooffset, const bool *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint64_frombool( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<bool, uint8_t>( uint8_t *toptr, int64_t tooffset, const bool *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint8_frombool( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<bool, uint16_t>( uint16_t *toptr, int64_t tooffset, const bool *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint16_frombool( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<bool, uint32_t>( uint32_t *toptr, int64_t tooffset, const bool *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint32_frombool( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<bool, uint64_t>( uint64_t *toptr, int64_t tooffset, const bool *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint64_frombool( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<bool, float>( float *toptr, int64_t tooffset, const bool *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat32_frombool( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<bool, double>( double *toptr, int64_t tooffset, const bool *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat64_frombool( toptr, tooffset, fromptr, fromoffset, length); }

  template<> ERROR NumpyArray_fill<int8_t, bool>( bool *toptr, int64_t tooffset, const int8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tobool_fromint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int8_t, int8_t>( int8_t *toptr, int64_t tooffset, const int8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint8_fromint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int8_t, int16_t>( int16_t *toptr, int64_t tooffset, const int8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint16_fromint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int8_t, int32_t>( int32_t *toptr, int64_t tooffset, const int8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint32_fromint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int8_t, int64_t>( int64_t *toptr, int64_t tooffset, const int8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint64_fromint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int8_t, uint8_t>( uint8_t *toptr, int64_t tooffset, const int8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint8_fromint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int8_t, uint16_t>( uint16_t *toptr, int64_t tooffset, const int8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint16_fromint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int8_t, uint32_t>( uint32_t *toptr, int64_t tooffset, const int8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint32_fromint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int8_t, uint64_t>( uint64_t *toptr, int64_t tooffset, const int8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint64_fromint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int8_t, float>( float *toptr, int64_t tooffset, const int8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat32_fromint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int8_t, double>( double *toptr, int64_t tooffset, const int8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat64_fromint8( toptr, tooffset, fromptr, fromoffset, length); }

  template<> ERROR NumpyArray_fill<int16_t, bool>( bool *toptr, int64_t tooffset, const int16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tobool_fromint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int16_t, int8_t>( int8_t *toptr, int64_t tooffset, const int16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint8_fromint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int16_t, int16_t>( int16_t *toptr, int64_t tooffset, const int16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint16_fromint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int16_t, int32_t>( int32_t *toptr, int64_t tooffset, const int16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint32_fromint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int16_t, int64_t>( int64_t *toptr, int64_t tooffset, const int16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint64_fromint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int16_t, uint8_t>( uint8_t *toptr, int64_t tooffset, const int16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint8_fromint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int16_t, uint16_t>( uint16_t *toptr, int64_t tooffset, const int16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint16_fromint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int16_t, uint32_t>( uint32_t *toptr, int64_t tooffset, const int16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint32_fromint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int16_t, uint64_t>( uint64_t *toptr, int64_t tooffset, const int16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint64_fromint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int16_t, float>( float *toptr, int64_t tooffset, const int16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat32_fromint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int16_t, double>( double *toptr, int64_t tooffset, const int16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat64_fromint16( toptr, tooffset, fromptr, fromoffset, length); }

  template<> ERROR NumpyArray_fill<int32_t, bool>( bool *toptr, int64_t tooffset, const int32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tobool_fromint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int32_t, int8_t>( int8_t *toptr, int64_t tooffset, const int32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint8_fromint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int32_t, int16_t>( int16_t *toptr, int64_t tooffset, const int32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint16_fromint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int32_t, int32_t>( int32_t *toptr, int64_t tooffset, const int32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint32_fromint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int32_t, int64_t>( int64_t *toptr, int64_t tooffset, const int32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint64_fromint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int32_t, uint8_t>( uint8_t *toptr, int64_t tooffset, const int32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint8_fromint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int32_t, uint16_t>( uint16_t *toptr, int64_t tooffset, const int32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint16_fromint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int32_t, uint32_t>( uint32_t *toptr, int64_t tooffset, const int32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint32_fromint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int32_t, uint64_t>( uint64_t *toptr, int64_t tooffset, const int32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint64_fromint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int32_t, float>( float *toptr, int64_t tooffset, const int32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat32_fromint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int32_t, double>( double *toptr, int64_t tooffset, const int32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat64_fromint32( toptr, tooffset, fromptr, fromoffset, length); }

  template<> ERROR NumpyArray_fill<int64_t, bool>( bool *toptr, int64_t tooffset, const int64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tobool_fromint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int64_t, int8_t>( int8_t *toptr, int64_t tooffset, const int64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint8_fromint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int64_t, int16_t>( int16_t *toptr, int64_t tooffset, const int64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint16_fromint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int64_t, int32_t>( int32_t *toptr, int64_t tooffset, const int64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint32_fromint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int64_t, int64_t>( int64_t *toptr, int64_t tooffset, const int64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint64_fromint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int64_t, uint8_t>( uint8_t *toptr, int64_t tooffset, const int64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint8_fromint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int64_t, uint16_t>( uint16_t *toptr, int64_t tooffset, const int64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint16_fromint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int64_t, uint32_t>( uint32_t *toptr, int64_t tooffset, const int64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint32_fromint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int64_t, uint64_t>( uint64_t *toptr, int64_t tooffset, const int64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint64_fromint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int64_t, float>( float *toptr, int64_t tooffset, const int64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat32_fromint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<int64_t, double>( double *toptr, int64_t tooffset, const int64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat64_fromint64( toptr, tooffset, fromptr, fromoffset, length); }

  template<> ERROR NumpyArray_fill<uint8_t, bool>( bool *toptr, int64_t tooffset, const uint8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tobool_fromuint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint8_t, int8_t>( int8_t *toptr, int64_t tooffset, const uint8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint8_fromuint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint8_t, int16_t>( int16_t *toptr, int64_t tooffset, const uint8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint16_fromuint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint8_t, int32_t>( int32_t *toptr, int64_t tooffset, const uint8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint32_fromuint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint8_t, int64_t>( int64_t *toptr, int64_t tooffset, const uint8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint64_fromuint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint8_t, uint8_t>( uint8_t *toptr, int64_t tooffset, const uint8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint8_fromuint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint8_t, uint16_t>( uint16_t *toptr, int64_t tooffset, const uint8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint16_fromuint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint8_t, uint32_t>( uint32_t *toptr, int64_t tooffset, const uint8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint32_fromuint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint8_t, uint64_t>( uint64_t *toptr, int64_t tooffset, const uint8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint64_fromuint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint8_t, float>( float *toptr, int64_t tooffset, const uint8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat32_fromuint8( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint8_t, double>( double *toptr, int64_t tooffset, const uint8_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat64_fromuint8( toptr, tooffset, fromptr, fromoffset, length); }

  template<> ERROR NumpyArray_fill<uint16_t, bool>( bool *toptr, int64_t tooffset, const uint16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tobool_fromuint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint16_t, int8_t>( int8_t *toptr, int64_t tooffset, const uint16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint8_fromuint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint16_t, int16_t>( int16_t *toptr, int64_t tooffset, const uint16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint16_fromuint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint16_t, int32_t>( int32_t *toptr, int64_t tooffset, const uint16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint32_fromuint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint16_t, int64_t>( int64_t *toptr, int64_t tooffset, const uint16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint64_fromuint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint16_t, uint8_t>( uint8_t *toptr, int64_t tooffset, const uint16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint8_fromuint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint16_t, uint16_t>( uint16_t *toptr, int64_t tooffset, const uint16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint16_fromuint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint16_t, uint32_t>( uint32_t *toptr, int64_t tooffset, const uint16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint32_fromuint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint16_t, uint64_t>( uint64_t *toptr, int64_t tooffset, const uint16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint64_fromuint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint16_t, float>( float *toptr, int64_t tooffset, const uint16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat32_fromuint16( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint16_t, double>( double *toptr, int64_t tooffset, const uint16_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat64_fromuint16( toptr, tooffset, fromptr, fromoffset, length); }

  template<> ERROR NumpyArray_fill<uint32_t, bool>( bool *toptr, int64_t tooffset, const uint32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tobool_fromuint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint32_t, int8_t>( int8_t *toptr, int64_t tooffset, const uint32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint8_fromuint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint32_t, int16_t>( int16_t *toptr, int64_t tooffset, const uint32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint16_fromuint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint32_t, int32_t>( int32_t *toptr, int64_t tooffset, const uint32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint32_fromuint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint32_t, int64_t>( int64_t *toptr, int64_t tooffset, const uint32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint64_fromuint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint32_t, uint8_t>( uint8_t *toptr, int64_t tooffset, const uint32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint8_fromuint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint32_t, uint16_t>( uint16_t *toptr, int64_t tooffset, const uint32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint16_fromuint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint32_t, uint32_t>( uint32_t *toptr, int64_t tooffset, const uint32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint32_fromuint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint32_t, uint64_t>( uint64_t *toptr, int64_t tooffset, const uint32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint64_fromuint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint32_t, float>( float *toptr, int64_t tooffset, const uint32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat32_fromuint32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint32_t, double>( double *toptr, int64_t tooffset, const uint32_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat64_fromuint32( toptr, tooffset, fromptr, fromoffset, length); }

  template<> ERROR NumpyArray_fill<uint64_t, bool>( bool *toptr, int64_t tooffset, const uint64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tobool_fromuint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint64_t, int8_t>( int8_t *toptr, int64_t tooffset, const uint64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint8_fromuint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint64_t, int16_t>( int16_t *toptr, int64_t tooffset, const uint64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint16_fromuint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint64_t, int32_t>( int32_t *toptr, int64_t tooffset, const uint64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint32_fromuint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint64_t, int64_t>( int64_t *toptr, int64_t tooffset, const uint64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint64_fromuint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint64_t, uint8_t>( uint8_t *toptr, int64_t tooffset, const uint64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint8_fromuint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint64_t, uint16_t>( uint16_t *toptr, int64_t tooffset, const uint64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint16_fromuint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint64_t, uint32_t>( uint32_t *toptr, int64_t tooffset, const uint64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint32_fromuint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint64_t, uint64_t>( uint64_t *toptr, int64_t tooffset, const uint64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint64_fromuint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint64_t, float>( float *toptr, int64_t tooffset, const uint64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat32_fromuint64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<uint64_t, double>( double *toptr, int64_t tooffset, const uint64_t *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat64_fromuint64( toptr, tooffset, fromptr, fromoffset, length); }

  template<> ERROR NumpyArray_fill<float, bool>( bool *toptr, int64_t tooffset, const float *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tobool_fromfloat32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<float, int8_t>( int8_t *toptr, int64_t tooffset, const float *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint8_fromfloat32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<float, int16_t>( int16_t *toptr, int64_t tooffset, const float *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint16_fromfloat32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<float, int32_t>( int32_t *toptr, int64_t tooffset, const float *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint32_fromfloat32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<float, int64_t>( int64_t *toptr, int64_t tooffset, const float *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint64_fromfloat32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<float, uint8_t>( uint8_t *toptr, int64_t tooffset, const float *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint8_fromfloat32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<float, uint16_t>( uint16_t *toptr, int64_t tooffset, const float *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint16_fromfloat32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<float, uint32_t>( uint32_t *toptr, int64_t tooffset, const float *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint32_fromfloat32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<float, uint64_t>( uint64_t *toptr, int64_t tooffset, const float *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint64_fromfloat32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<float, float>( float *toptr, int64_t tooffset, const float *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat32_fromfloat32( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<float, double>( double *toptr, int64_t tooffset, const float *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat64_fromfloat32( toptr, tooffset, fromptr, fromoffset, length); }

  template<> ERROR NumpyArray_fill<double, bool>( bool *toptr, int64_t tooffset, const double *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tobool_fromfloat64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<double, int8_t>( int8_t *toptr, int64_t tooffset, const double *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint8_fromfloat64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<double, int16_t>( int16_t *toptr, int64_t tooffset, const double *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint16_fromfloat64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<double, int32_t>( int32_t *toptr, int64_t tooffset, const double *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint32_fromfloat64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<double, int64_t>( int64_t *toptr, int64_t tooffset, const double *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_toint64_fromfloat64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<double, uint8_t>( uint8_t *toptr, int64_t tooffset, const double *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint8_fromfloat64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<double, uint16_t>( uint16_t *toptr, int64_t tooffset, const double *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint16_fromfloat64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<double, uint32_t>( uint32_t *toptr, int64_t tooffset, const double *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint32_fromfloat64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<double, uint64_t>( uint64_t *toptr, int64_t tooffset, const double *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_touint64_fromfloat64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<double, float>( float *toptr, int64_t tooffset, const double *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat32_fromfloat64( toptr, tooffset, fromptr, fromoffset, length); }
  template<> ERROR NumpyArray_fill<double, double>( double *toptr, int64_t tooffset, const double *fromptr, int64_t fromoffset, int64_t length) { return awkward_NumpyArray_fill_tofloat64_fromfloat64( toptr, tooffset, fromptr, fromoffset, length); }
