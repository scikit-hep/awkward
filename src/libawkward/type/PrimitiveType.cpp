...
namespace awkward {
std::string PrimitiveType::tostring_part(std::string indent, std::string pre,
...
bool PrimitiveType::equal(const std::shared_ptr<Type> other,
...
std::shared_ptr<Type> PrimitiveType::level() const { return shallow_copy(); }
...
int64_t PrimitiveType::numfields() const { return -1; }
...
PrimitiveType::keyaliases(int64_t fieldindex) const {
  throw std::invalid_argument("type contains no Records");
}

const std::vector<std::string>
PrimitiveType::keyaliases(const std::string &key) const {
  throw std::invalid_argument("type contains no Records");
}
...
const PrimitiveType::DType PrimitiveType::dtype() const { return dtype_; }
} // namespace awkward
