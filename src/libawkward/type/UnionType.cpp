...
namespace awkward {
std::string UnionType::tostring_part(std::string indent, std::string pre,
...
bool UnionType::equal(const std::shared_ptr<Type> other,
...
int64_t UnionType::numtypes() const { return (int64_t)types_.size(); }
...
UnionType::keyaliases(const std::string &key) const {
