...
namespace awkward {
  ...
  template <>
  const std::shared_ptr<Content> ListOffsetArrayOf<int32_t>::getitem_next(const std::shared_ptr<SliceItem> head, const Slice& tail, const Index64& advanced, bool fake) const {
  ...
  template <>
  const std::shared_ptr<Content> ListOffsetArrayOf<int64_t>::getitem_next(const std::shared_ptr<SliceItem> head, const Slice& tail, const Index64& advanced, bool fake) const {
    int64_t lenstarts = offsets_.length() - 1;
  ...
  template <>
  const std::shared_ptr<Content> ListOffsetArrayOf<int32_t>::carry(const Index64& carry, bool fake) const {
    Index32 starts = make_starts(offsets_);
    Index32 stops = make_stops(offsets_);
  ...
  template <>
  const std::shared_ptr<Content> ListOffsetArrayOf<int64_t>::carry(const Index64& carry, bool fake) const {
    Index64 starts = make_starts(offsets_);
    Index64 stops = make_stops(offsets_);
