...
namespace awkward {
template <typename T> const std::string IndexOf<T>::classname() const {
...
template <typename T> const std::string IndexOf<T>::tostring() const {
  return tostring_part("", "", "");
}

template <typename T>
const std::string IndexOf<T>::tostring_part(const std::string indent,
...
template <typename T> T IndexOf<T>::getitem_at(int64_t at) const {
...
template <typename T> T IndexOf<T>::getitem_at_nowrap(int64_t at) const {
