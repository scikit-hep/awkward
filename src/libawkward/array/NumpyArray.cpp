...
namespace awkward {
  ...
  NumpyArray::reduce_next(const Reducer& reducer,
    ...
    if (shape_.empty()) {
      ...
      util::dtype npdtype = reducer.return_npdtype(format_);
...
#endif
      ssize_t itemsize = 8;
      util::dtype npdtype = util::dtype::int64;
