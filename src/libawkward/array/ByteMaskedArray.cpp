...
namespace awkward {
  ...
  const std::shared_ptr<Content> ByteMaskedArray::sort_next(int64_t negaxis, const Index64& starts, const Index64& parents, int64_t outlength, bool ascending, bool stable) const {
    throw std::runtime_error("FIXME: ByteMaskedArray::sort_next is not implemened");
  }
