...
namespace awkward {
  ...
  template <typename T, typename I>
  const std::shared_ptr<Content> UnionArrayOf<T, I>::choose(int64_t n, const std::shared_ptr<util::RecordLookup>& recordlookup, const util::Parameters& parameters, int64_t axis, int64_t depth) const {
    throw std::runtime_error("FIXME: UnionArray::choose");
  }
