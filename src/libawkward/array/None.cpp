...
namespace awkward {
  ...
  const std::shared_ptr<Content> None::sort_next(int64_t negaxis, const Index64& starts, const Index64& parents, int64_t outlength, bool ascending, bool stable) const {
