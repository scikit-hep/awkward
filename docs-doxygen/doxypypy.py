...
### doxypypy.py was written by Eric W. Brown (https://github.com/Feneric)
### and is available on
###
###    - GitHub: https://github.com/Feneric/doxypypy
###    - PyPI:   https://pypi.org/project/doxypypy
###
### Its license is GPL-2, which we comply with because Awkward Array is a
### free, non-commercial, open-source project (BSD-3). Commercial projects
### are still free to use Awkward Array (i.e. the GPL-2 is not "sticky")
### because doxypypy.py is not used as _part_ of Awkward Array but as a
### way to generate its documentation.
###
###    - https://github.com/Feneric/doxypypy/blob/master/LICENSE.txt
###
### We have forked the doxypypy.py script from its May 2, 2019 state,
###
###    - https://github.com/Feneric/doxypypy/commit/2a89e6ac76fb28717adabb6c1c6b1d198e021148
###
### because we need to customize behavior for our docstrings. The file that
### follows is covered by the doxypypy.py license, not the Awkward license,
### and is modified in accordance with the permissions granted by GPL-2.
