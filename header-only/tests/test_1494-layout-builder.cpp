...
using ByteMaskedBuilder =
    awkward::LayoutBuilder::ByteMasked<VALID_WHEN, BUILDER>;
...
template <class... BUILDERS>
using UnionBuilder8_U32 =
    awkward::LayoutBuilder::Union<int8_t, uint32_t, BUILDERS...>;
...
void test_Record() {
  ...
  UserDefinedMap fields_map(
      {{Field::one, "one"}, {Field::two, "two"}, {Field::three, "three"}});
...
void test_Record_Record() {
  ...
  UserDefinedMap fields_map1({{Field1::u, "u"}, {Field1::v, "v"}});

  enum Field2 : std::size_t { w };

  UserDefinedMap fields_map2({{Field2::w, "w"}});
  ...
  RecordBuilder<
      RecordField<
          ...
          RecordBuilder<
              ...
              RecordField<Field1::v,
                          ListOffsetBuilder<int64_t, NumpyBuilder<int64_t>>>>>,
      RecordField<Field0::y,
                  RecordBuilder<RecordField<Field2::w, NumpyBuilder<char>>>>>
      builder;
...
void test_Record_nested() {
  ...
  UserDefinedMap fields_map0(
      {{Field0::u, "u"}, {Field0::v, "v"}, {Field0::w, "w"}});

  enum Field1 : std::size_t { i, j };

  UserDefinedMap fields_map1({{Field1::i, "i"}, {Field1::j, "j"}});
...
void test_Union8_64_ListOffset_Record() {
  ...
  UnionBuilder8_64<ListOffsetBuilder<int64_t, NumpyBuilder<double>>,
                   RecordBuilder<RecordField<Field::x, NumpyBuilder<int64_t>>,
