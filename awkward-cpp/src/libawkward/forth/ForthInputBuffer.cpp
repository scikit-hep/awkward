...
#define FILENAME(line) \
  FILENAME_FOR_EXCEPTIONS("src/libawkward/forth/ForthInputBuffer.cpp", line)
...
namespace awkward {
  ForthInputBuffer::ForthInputBuffer(const std::shared_ptr<void> ptr,
                                     int64_t offset,
                                     int64_t length)
      : ptr_(ptr), offset_(offset), length_(length), pos_(0) {}
  ...
  ForthInputBuffer::peek_byte(int64_t after, util::ForthError& err) noexcept {
    ...
    return *reinterpret_cast<uint8_t*>(reinterpret_cast<size_t>(ptr_.get()) +
                                       (size_t)offset_ + (size_t)pos_ +
                                       (size_t)after);
  }
  ...
  ForthInputBuffer::read(int64_t num_bytes, util::ForthError& err) noexcept {
    ...
    int64_t tmp = pos_;
    pos_ = next;
    return reinterpret_cast<void*>(reinterpret_cast<size_t>(ptr_.get()) +
                                   (size_t)offset_ + (size_t)tmp);
  }
  ...
  int64_t
  ForthInputBuffer::read_enum(const std::vector<std::string>& strings,
                              int64_t start,
  ...
  double exponents[616] = {
      ...
      1e-099, 1e-098, 1e-097, 1e-096, 1e-095, 1e-094, 1e-093, 1e-092, 1e-091,
      1e-090, 1e-089, 1e-088, 1e-087, 1e-086, 1e-085, 1e-084, 1e-083, 1e-082,
      1e-081, 1e-080, 1e-079, 1e-078, 1e-077, 1e-076, 1e-075, 1e-074, 1e-073,
      1e-072, 1e-071, 1e-070, 1e-069, 1e-068, 1e-067, 1e-066, 1e-065, 1e-064,
      1e-063, 1e-062, 1e-061, 1e-060, 1e-059, 1e-058, 1e-057, 1e-056, 1e-055,
      1e-054, 1e-053, 1e-052, 1e-051, 1e-050, 1e-049, 1e-048, 1e-047, 1e-046,
      1e-045, 1e-044, 1e-043, 1e-042, 1e-041, 1e-040, 1e-039, 1e-038, 1e-037,
      1e-036, 1e-035, 1e-034, 1e-033, 1e-032, 1e-031, 1e-030, 1e-029, 1e-028,
      1e-027, 1e-026, 1e-025, 1e-024, 1e-023, 1e-022, 1e-021, 1e-020, 1e-019,
      1e-018, 1e-017, 1e-016, 1e-015, 1e-014, 1e-013, 1e-012, 1e-011, 1e-010,
      ...
      1e+018, 1e+019, 1e+020, 1e+021, 1e+022, 1e+023, 1e+024, 1e+025, 1e+026,
      1e+027, 1e+028, 1e+029, 1e+030, 1e+031, 1e+032, 1e+033, 1e+034, 1e+035,
      1e+036, 1e+037, 1e+038, 1e+039, 1e+040, 1e+041, 1e+042, 1e+043, 1e+044,
      1e+045, 1e+046, 1e+047, 1e+048, 1e+049, 1e+050, 1e+051, 1e+052, 1e+053,
      1e+054, 1e+055, 1e+056, 1e+057, 1e+058, 1e+059, 1e+060, 1e+061, 1e+062,
      1e+063, 1e+064, 1e+065, 1e+066, 1e+067, 1e+068, 1e+069, 1e+070, 1e+071,
      1e+072, 1e+073, 1e+074, 1e+075, 1e+076, 1e+077, 1e+078, 1e+079, 1e+080,
      1e+081, 1e+082, 1e+083, 1e+084, 1e+085, 1e+086, 1e+087, 1e+088, 1e+089,
      1e+090, 1e+091, 1e+092, 1e+093, 1e+094, 1e+095, 1e+096, 1e+097, 1e+098,
      1e+099,
  ...
  void
  ForthInputBuffer::read_quotedstr(char* string_buffer,
  ...
  ForthInputBuffer::skipws() noexcept {
    uint8_t* byte;
    while (pos_ < length_) {
      byte = reinterpret_cast<uint8_t*>(reinterpret_cast<size_t>(ptr_.get()) +
                                        (size_t)offset_ + (size_t)pos_);
      if (*byte == ' ' || *byte == '\n' || *byte == '\r' || *byte == '\t') {
        pos_++;
      } else {
