...
#define FILENAME(line)       \
  FILENAME_FOR_EXCEPTIONS_C( \
      "src/cpu-kernels/awkward_ListOffsetArray_drop_none_indexes.cpp", line)

#include "awkward/kernels.h"

template <typename T>
ERROR
awkward_ListOffsetArray_drop_none_indexes(T* tooffsets,
                                          const T* noneindexes,
                                          const T* fromoffsets,
...
ERROR
awkward_ListOffsetArray_drop_none_indexes_64(int64_t* tooffsets,
...
ERROR
awkward_ListOffsetArray_drop_none_indexes_32(int32_t* tooffsets,
