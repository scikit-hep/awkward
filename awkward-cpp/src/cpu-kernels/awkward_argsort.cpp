...
#define FILENAME(line) \
  FILENAME_FOR_EXCEPTIONS_C("src/cpu-kernels/awkward_argsort.cpp", line)
...
template <typename T>
bool
argsort_order_ascending(T l, T r) {
...
template <typename T>
bool
argsort_order_descending(T l, T r) {
  return !std::isnan(static_cast<double>(r)) &&
         (std::isnan(static_cast<double>(l)) || l > r);
}
...
ERROR
awkward_argsort_bool(int64_t* toptr,
                     const bool* fromptr,
                     int64_t length,
                     const int64_t* offsets,
                     int64_t offsetslength,
...
ERROR
awkward_argsort_int8(int64_t* toptr,
...
ERROR
awkward_argsort_uint8(int64_t* toptr,
...
ERROR
awkward_argsort_int16(int64_t* toptr,
...
ERROR
awkward_argsort_uint16(int64_t* toptr,
...
ERROR
awkward_argsort_int32(int64_t* toptr,
...
ERROR
awkward_argsort_uint32(int64_t* toptr,
...
ERROR
awkward_argsort_int64(int64_t* toptr,
...
ERROR
awkward_argsort_uint64(int64_t* toptr,
...
ERROR
awkward_argsort_float32(int64_t* toptr,
                        const float* fromptr,
                        int64_t length,
                        const int64_t* offsets,
                        int64_t offsetslength,
...
ERROR
awkward_argsort_float64(int64_t* toptr,
...
template <>
bool
argsort_order_ascending(bool l, bool r) {
  return l < r;
}

template <>
bool
argsort_order_descending(bool l, bool r) {
  return l > r;
}
