...
#define FILENAME(line)       \
  FILENAME_FOR_EXCEPTIONS_C( \
      "src/cpu-kernels/awkward_ListArray_getitem_jagged_numvalid.cpp", line)

#include "awkward/kernels.h"

template <typename T>
ERROR
awkward_ListArray_getitem_jagged_numvalid(int64_t* numvalid,
                                          const T* slicestarts,
                                          const T* slicestops,
                                          int64_t length,
                                          const T* missing,
...
ERROR
awkward_ListArray_getitem_jagged_numvalid_64(int64_t* numvalid,
