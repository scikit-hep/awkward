...
ERROR
awkward_IndexedArray_getitem_nextcarry_outindex(T* tocarry,
                                                C* toindex,
                                                const C* fromindex,
                                                int64_t lenindex,
                                                int64_t lencontent) {
...
ERROR
awkward_IndexedArray32_getitem_nextcarry_outindex_64(int64_t* tocarry,
                                                     int32_t* toindex,
...
ERROR
awkward_IndexedArrayU32_getitem_nextcarry_outindex_64(int64_t* tocarry,
                                                      uint32_t* toindex,
...
ERROR
awkward_IndexedArray64_getitem_nextcarry_outindex_64(int64_t* tocarry,
                                                     int64_t* toindex,
