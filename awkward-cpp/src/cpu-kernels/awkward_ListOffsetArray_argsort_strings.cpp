...
#define FILENAME(line)       \
  FILENAME_FOR_EXCEPTIONS_C( \
      "src/cpu-kernels/awkward_ListOffsetArray_argsort_strings.cpp", line)
...
ERROR
awkward_ListOffsetArray_argsort_strings_impl(int64_t* tocarry,
                                             const int64_t* fromparents,
                                             int64_t length,
                                             const char* stringdata,
                                             const int64_t* stringstarts,
                                             const int64_t* stringstops) {
  auto sorter = [&stringdata, &stringstarts, &stringstops](
                    int64_t left, int64_t right) -> bool {
...
ERROR
awkward_ListOffsetArray_argsort_strings(int64_t* tocarry,
                                        const int64_t* fromparents,
                                        int64_t length,
