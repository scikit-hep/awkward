...
#define FILENAME(line)       \
  FILENAME_FOR_EXCEPTIONS_C( \
      "src/cpu-kernels/awkward_reduce_prod_bool_complex.cpp", line)

#include "awkward/kernels.h"

template <typename IN>
ERROR
awkward_reduce_prod_bool_complex(bool* toptr,
                                 const IN* fromptr,
...
ERROR
awkward_reduce_prod_bool_complex64_64(bool* toptr,
                                      const float* fromptr,
                                      const int64_t* parents,
                                      int64_t lenparents,
                                      int64_t outlength) {
...
ERROR
awkward_reduce_prod_bool_complex128_64(bool* toptr,
