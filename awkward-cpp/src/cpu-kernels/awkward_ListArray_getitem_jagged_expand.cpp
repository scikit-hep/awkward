...
#define FILENAME(line)       \
  FILENAME_FOR_EXCEPTIONS_C( \
      "src/cpu-kernels/awkward_ListArray_getitem_jagged_expand.cpp", line)
...
awkward_ListArray_getitem_jagged_expand(T* multistarts,
  ...
  for (int64_t i = 0; i < length; i++) {
    ...
    if (stop - start != jaggedsize) {
      return failure("cannot fit jagged slice into nested list",
                     i,
                     kSliceNone,
                     FILENAME(__LINE__));
    }
...
ERROR
awkward_ListArray32_getitem_jagged_expand_64(int64_t* multistarts,
                                             int64_t* multistops,
...
ERROR
awkward_ListArrayU32_getitem_jagged_expand_64(int64_t* multistarts,
                                              int64_t* multistops,
                                              const int64_t* singleoffsets,
                                              int64_t* tocarry,
...
ERROR
awkward_ListArray64_getitem_jagged_expand_64(int64_t* multistarts,
                                             int64_t* multistops,
                                             const int64_t* singleoffsets,
                                             int64_t* tocarry,
