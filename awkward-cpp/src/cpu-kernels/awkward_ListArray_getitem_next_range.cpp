...
#define FILENAME(line)       \
  FILENAME_FOR_EXCEPTIONS_C( \
      "src/cpu-kernels/awkward_ListArray_getitem_next_range.cpp", line)
...
ERROR
awkward_ListArray_getitem_next_range(C* tooffsets,
                                     T* tocarry,
                                     const C* fromstarts,
                                     const C* fromstops,
                                     int64_t lenstarts,
...
ERROR
awkward_ListArray32_getitem_next_range_64(int32_t* tooffsets,
                                          int64_t* tocarry,
...
ERROR
awkward_ListArrayU32_getitem_next_range_64(uint32_t* tooffsets,
                                           int64_t* tocarry,
...
ERROR
awkward_ListArray64_getitem_next_range_64(int64_t* tooffsets,
                                          int64_t* tocarry,
