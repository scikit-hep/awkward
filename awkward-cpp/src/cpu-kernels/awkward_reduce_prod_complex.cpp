...
#define FILENAME(line)                                                         \
  FILENAME_FOR_EXCEPTIONS_C("src/cpu-kernels/awkward_reduce_prod_complex.cpp", \
                            line)
...
ERROR
awkward_reduce_prod_complex(OUT* toptr,
                            const IN* fromptr,
...
ERROR
awkward_reduce_prod_complex64_complex64_64(float* toptr,
                                           const float* fromptr,
                                           const int64_t* parents,
                                           int64_t lenparents,
                                           int64_t outlength) {
...
ERROR
awkward_reduce_prod_complex128_complex128_64(double* toptr,
