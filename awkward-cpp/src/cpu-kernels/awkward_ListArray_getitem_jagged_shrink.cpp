...
#define FILENAME(line)       \
  FILENAME_FOR_EXCEPTIONS_C( \
      "src/cpu-kernels/awkward_ListArray_getitem_jagged_shrink.cpp", line)

#include "awkward/kernels.h"

template <typename T>
ERROR
awkward_ListArray_getitem_jagged_shrink(T* tocarry,
                                        T* tosmalloffsets,
                                        T* tolargeoffsets,
                                        const T* slicestarts,
                                        const T* slicestops,
...
ERROR
awkward_ListArray_getitem_jagged_shrink_64(int64_t* tocarry,
  ...
  return awkward_ListArray_getitem_jagged_shrink<int64_t>(tocarry,
                                                          tosmalloffsets,
                                                          tolargeoffsets,
                                                          slicestarts,
                                                          slicestops,
