...
#define FILENAME(line) \
  FILENAME_FOR_EXCEPTIONS_C("src/cpu-kernels/awkward_reduce_argmin.cpp", line)
...
ERROR
awkward_reduce_argmin_int8_64(int64_t* toptr,
...
ERROR
awkward_reduce_argmin_uint8_64(int64_t* toptr,
...
ERROR
awkward_reduce_argmin_int16_64(int64_t* toptr,
...
ERROR
awkward_reduce_argmin_uint16_64(int64_t* toptr,
...
ERROR
awkward_reduce_argmin_int32_64(int64_t* toptr,
...
ERROR
awkward_reduce_argmin_uint32_64(int64_t* toptr,
...
ERROR
awkward_reduce_argmin_int64_64(int64_t* toptr,
...
ERROR
awkward_reduce_argmin_uint64_64(int64_t* toptr,
...
ERROR
awkward_reduce_argmin_float32_64(int64_t* toptr,
                                 const float* fromptr,
                                 const int64_t* parents,
                                 int64_t lenparents,
                                 int64_t outlength) {
...
ERROR
awkward_reduce_argmin_float64_64(int64_t* toptr,
