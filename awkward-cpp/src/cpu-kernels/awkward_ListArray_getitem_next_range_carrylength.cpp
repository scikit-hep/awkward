...
template <typename C>
ERROR
awkward_ListArray_getitem_next_range_carrylength(int64_t* carrylength,
                                                 const C* fromstarts,
                                                 const C* fromstops,
                                                 int64_t lenstarts,
                                                 int64_t start,
...
ERROR
awkward_ListArray32_getitem_next_range_carrylength(int64_t* carrylength,
...
ERROR
awkward_ListArrayU32_getitem_next_range_carrylength(int64_t* carrylength,
...
ERROR
awkward_ListArray64_getitem_next_range_carrylength(int64_t* carrylength,
