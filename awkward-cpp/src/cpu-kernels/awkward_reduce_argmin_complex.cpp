...
ERROR awkward_reduce_argmin_complex64_64(
  ...
  const int64_t* offsets,
  int64_t outlength) {
  return awkward_reduce_argmin_complex<int64_t, float>(toptr, fromptr, offsets, outlength);
}
ERROR awkward_reduce_argmin_complex128_64(
  ...
  const int64_t* offsets,
  int64_t outlength) {
  return awkward_reduce_argmin_complex<int64_t, double>(toptr, fromptr, offsets, outlength);
}
