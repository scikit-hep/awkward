...
#define FILENAME(line)       \
  FILENAME_FOR_EXCEPTIONS_C( \
      "src/cpu-kernels/awkward_reduce_argmin_complex.cpp", line)

#include "awkward/kernels.h"

template <typename OUT, typename IN>
ERROR
awkward_reduce_argmin_complex(OUT* toptr,
                              const IN* fromptr,
...
ERROR
awkward_reduce_argmin_complex64_64(int64_t* toptr,
                                   const float* fromptr,
                                   const int64_t* parents,
                                   int64_t lenparents,
                                   int64_t outlength) {
...
ERROR
awkward_reduce_argmin_complex128_64(int64_t* toptr,
