...
#define FILENAME(line)       \
  FILENAME_FOR_EXCEPTIONS_C( \
      "src/cpu-kernels/awkward_ListArray_getitem_next_at.cpp", line)
...
ERROR
awkward_ListArray32_getitem_next_at_64(int64_t* tocarry,
                                       const int32_t* fromstarts,
                                       const int32_t* fromstops,
                                       int64_t lenstarts,
                                       int64_t at) {
  return awkward_ListArray_getitem_next_at<int32_t, int64_t>(
      tocarry, fromstarts, fromstops, lenstarts, at);
}
ERROR
awkward_ListArrayU32_getitem_next_at_64(int64_t* tocarry,
...
ERROR
awkward_ListArray64_getitem_next_at_64(int64_t* tocarry,
