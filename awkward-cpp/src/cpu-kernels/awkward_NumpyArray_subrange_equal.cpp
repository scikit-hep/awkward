...
#define FILENAME(line)       \
  FILENAME_FOR_EXCEPTIONS_C( \
      "src/cpu-kernels/awkward_NumpyArray_subrange_equal.cpp", line)

#include "awkward/kernels.h"

template <typename T>
ERROR
awkward_NumpyArray_subrange_equal(T* tmpptr,
...
ERROR
awkward_NumpyArray_subrange_equal_bool(bool* tmpptr,
                                       const int64_t* fromstarts,
                                       const int64_t* fromstops,
                                       int64_t length,
                                       bool* toequal) {
...
ERROR
awkward_NumpyArray_subrange_equal_int8(int8_t* tmpptr,
                                       const int64_t* fromstarts,
                                       const int64_t* fromstops,
                                       int64_t length,
                                       bool* toequal) {
...
ERROR
awkward_NumpyArray_subrange_equal_uint8(uint8_t* tmpptr,
                                        const int64_t* fromstarts,
                                        const int64_t* fromstops,
                                        int64_t length,
                                        bool* toequal) {
...
ERROR
awkward_NumpyArray_subrange_equal_int16(int16_t* tmpptr,
                                        const int64_t* fromstarts,
                                        const int64_t* fromstops,
                                        int64_t length,
                                        bool* toequal) {
...
ERROR
awkward_NumpyArray_subrange_equal_uint16(uint16_t* tmpptr,
                                         const int64_t* fromstarts,
                                         const int64_t* fromstops,
                                         int64_t length,
                                         bool* toequal) {
...
ERROR
awkward_NumpyArray_subrange_equal_int32(int32_t* tmpptr,
                                        const int64_t* fromstarts,
                                        const int64_t* fromstops,
                                        int64_t length,
                                        bool* toequal) {
...
ERROR
awkward_NumpyArray_subrange_equal_uint32(uint32_t* tmpptr,
                                         const int64_t* fromstarts,
                                         const int64_t* fromstops,
                                         int64_t length,
                                         bool* toequal) {
...
ERROR
awkward_NumpyArray_subrange_equal_int64(int64_t* tmpptr,
                                        const int64_t* fromstarts,
                                        const int64_t* fromstops,
                                        int64_t length,
                                        bool* toequal) {
...
ERROR
awkward_NumpyArray_subrange_equal_uint64(uint64_t* tmpptr,
                                         const int64_t* fromstarts,
                                         const int64_t* fromstops,
                                         int64_t length,
                                         bool* toequal) {
...
ERROR
awkward_NumpyArray_subrange_equal_float32(float* tmpptr,
                                          const int64_t* fromstarts,
                                          const int64_t* fromstops,
                                          int64_t length,
                                          bool* toequal) {
...
ERROR
awkward_NumpyArray_subrange_equal_float64(double* tmpptr,
                                          const int64_t* fromstarts,
                                          const int64_t* fromstops,
                                          int64_t length,
                                          bool* toequal) {
