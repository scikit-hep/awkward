...
#define FILENAME(line) \
  FILENAME_FOR_EXCEPTIONS_C("src/cpu-kernels/kernel-utils.cpp", line)

#include "awkward/kernel-utils.h"

void
awkward_regularize_rangeslice(int64_t* start,
                              int64_t* stop,
                              bool posstep,
                              bool hasstart,
                              bool hasstop,
...
void
awkward_ListArray_combinations_step_64(int64_t** tocarry,
                                       int64_t* toindex,
                                       int64_t* fromindex,
                                       int64_t j,
                                       int64_t stop,
