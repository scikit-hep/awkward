...
#define FILENAME(line)       \
  FILENAME_FOR_EXCEPTIONS_C( \
      "src/cpu-kernels/awkward_UnionArray_nestedfill_tags_index.cpp", line)

#include "awkward/kernels.h"

template <typename T, typename I, typename C>
ERROR
awkward_UnionArray_nestedfill_tags_index(T* totags,
                                         I* toindex,
                                         C* tmpstarts,
                                         T tag,
                                         const C* fromcounts,
...
ERROR
awkward_UnionArray8_32_nestedfill_tags_index_64(int8_t* totags,
                                                int32_t* toindex,
                                                int64_t* tmpstarts,
                                                int8_t tag,
...
ERROR
awkward_UnionArray8_U32_nestedfill_tags_index_64(int8_t* totags,
                                                 uint32_t* toindex,
                                                 int64_t* tmpstarts,
                                                 int8_t tag,
                                                 const int64_t* fromcounts,
...
ERROR
awkward_UnionArray8_64_nestedfill_tags_index_64(int8_t* totags,
                                                int64_t* toindex,
                                                int64_t* tmpstarts,
                                                int8_t tag,
                                                const int64_t* fromcounts,
