...
ERROR awkward_UnionArray_simplify(
  ...
  const OUTERTAGS* __restrict__ outertags,
  const OUTERINDEX* __restrict__ outerindex,
  const INNERTAGS* __restrict__ innertags,
  const INNERINDEX* __restrict__ innerindex,
  int64_t towhich,
  int64_t innerwhich,
  int64_t outerwhich,
  int64_t length,
