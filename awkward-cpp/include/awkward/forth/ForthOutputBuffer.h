...
#define NATIVELY_BIG_ENDIAN (*(uint16_t*)"\0\xff" < 0x100)
  ...
  public:
    ...
    /// @brief HERE
    virtual void
    write_uint16(int64_t num_items,
                 uint16_t* values,
                 bool byteswap) noexcept = 0;

    /// @brief HERE
    virtual void
    write_uint32(int64_t num_items,
                 uint32_t* values,
                 bool byteswap) noexcept = 0;

    /// @brief HERE
    virtual void
    write_uint64(int64_t num_items,
                 uint64_t* values,
                 bool byteswap) noexcept = 0;
    ...
    /// @brief HERE
    virtual void
    write_float64(int64_t num_items,
                  double* values,
                  bool byteswap) noexcept = 0;
  ...
  public:
    ...
    void
    write_bool(int64_t num_items,
               bool* values,
               bool byteswap) noexcept override;

    void
    write_int8(int64_t num_items,
               int8_t* values,
               bool byteswap) noexcept override;

    void
    write_int16(int64_t num_items,
                int16_t* values,
                bool byteswap) noexcept override;

    void
    write_int32(int64_t num_items,
                int32_t* values,
                bool byteswap) noexcept override;

    void
    write_int64(int64_t num_items,
                int64_t* values,
                bool byteswap) noexcept override;

    void
    write_intp(int64_t num_items,
               ssize_t* values,
               bool byteswap) noexcept override;

    void
    write_const_uint8(int64_t num_items,
                      const uint8_t* values) noexcept override;

    void
    write_uint8(int64_t num_items,
                uint8_t* values,
                bool byteswap) noexcept override;
    ...
    void
    write_uintp(int64_t num_items,
                size_t* values,
                bool byteswap) noexcept override;

    void
    write_float32(int64_t num_items,
                  float* values,
                  bool byteswap) noexcept override;
  ...
  private:
    ...
    template <typename IN>
    inline void
    write_copy(int64_t num_items, const IN* values) noexcept {
