...
def test_num():
    ...
    assert awkward1.num(cuda_listoffsetarray, 0) == awkward1.num(listoffsetarray, 0)
    assert awkward1.num(cuda_listoffsetarray, 1) == awkward1.num(listoffsetarray, 1)

    cuda_regulararray = awkward1.copy_to(regulararray, "cuda")
    assert awkward1.num(cuda_regulararray, 0) == awkward1.num(regulararray, 0)
    assert awkward1.num(cuda_regulararray, 1) == awkward1.num(regulararray, 1)

    cuda_listarray = awkward1.copy_to(listarray, "cuda")
    assert awkward1.num(cuda_listarray, 0) == awkward1.num(listarray, 0)
    assert awkward1.num(cuda_listarray, 1) == awkward1.num(listarray, 1)
    ...
    assert awkward1.num(cuda_recordarray, 0) == awkward1.num(recordarray, 0)
