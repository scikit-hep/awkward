...
Defined in [awkward.operations.ak_covar](https://github.com/scikit-hep/awkward/blob/eb8319fc07e72e9c77dc6c53b77980ef89c43fe4/src/awkward/operations/ak_covar.py) on [line 23](https://github.com/scikit-hep/awkward/blob/eb8319fc07e72e9c77dc6c53b77980ef89c43fe4/src/awkward/operations/ak_covar.py#L23).

#### ak.covar(x, y, weight=None, axis=None, \*, keepdims=False, mask_identity=False, highlevel=True, behavior=None, attrs=None)
...
* **Parameters:**
  * **x** – One coordinate to use in the covariance calculation (anything [`ak.to_layout`](sphinx-llm:403123410bfd489c81c0ce600f3e7695#ak.to_layout) recognizes).
  * **y** – The other coordinate to use in the covariance calculation (anything [`ak.to_layout`](sphinx-llm:403123410bfd489c81c0ce600f3e7695#ak.to_layout) recognizes).
