...
Defined in [awkward.forms.bytemaskedform](https://github.com/scikit-hep/awkward/blob/eb8319fc07e72e9c77dc6c53b77980ef89c43fe4/src/awkward/forms/bytemaskedform.py) on [line 19](https://github.com/scikit-hep/awkward/blob/eb8319fc07e72e9c77dc6c53b77980ef89c43fe4/src/awkward/forms/bytemaskedform.py#L19).

#### *class* ak.forms.ByteMaskedForm(mask, content, valid_when, \*, parameters=None, form_key=None)
...
#### copy(mask=UNSET, content=UNSET, valid_when=UNSET, \*, parameters=UNSET, form_key=UNSET)

#### *classmethod* simplified(mask, content, valid_when, \*, parameters=None, form_key=None)

#### *property* is_identity_like *: [bool](https://docs.python.org/3/library/functions.html#bool)*
