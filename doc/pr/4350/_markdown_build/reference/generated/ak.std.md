...
Defined in [awkward.operations.ak_std](https://github.com/scikit-hep/awkward/blob/eb8319fc07e72e9c77dc6c53b77980ef89c43fe4/src/awkward/operations/ak_std.py) on [line 29](https://github.com/scikit-hep/awkward/blob/eb8319fc07e72e9c77dc6c53b77980ef89c43fe4/src/awkward/operations/ak_std.py#L29).

#### ak.std(x, weight=None, ddof=0, axis=None, \*, keepdims=False, mask_identity=False, highlevel=True, behavior=None, attrs=None)
...
See also [`ak.nanstd`](sphinx-llm:04d355ec5f954c2496e15e883ce67410#ak.nanstd).

* **Parameters:**
  * **x** – The data on which to compute the standard deviation (anything [`ak.to_layout`](sphinx-llm:403123410bfd489c81c0ce600f3e7695#ak.to_layout) recognizes).
