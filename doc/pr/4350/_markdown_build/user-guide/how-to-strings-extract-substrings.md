...
Let’s use the [`re`](https://docs.python.org/3/library/re.html#module-re) module to use the above pattern to parse this line
...
Let’s now apply [`ak.str.extract_regex()`](sphinx-llm:6d4162a34ed24e1fba7d6c7d466d4710#ak.str.extract_regex) to our array of lines using this pattern
