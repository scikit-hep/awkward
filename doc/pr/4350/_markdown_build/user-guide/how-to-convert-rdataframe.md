...
The function for Awkward → `RDataFrame` conversion is [`ak.to_rdataframe()`](sphinx-llm:130d58a880d04dc49249c7acc0602655#ak.to_rdataframe).
...
The [`ak.to_rdataframe()`](sphinx-llm:130d58a880d04dc49249c7acc0602655#ak.to_rdataframe) function presents a generated-on-demand Awkward Array view as an `RDataFrame` source. There is a small overhead of generating Awkward RDataSource C++ code. This operation does not execute the `RDataFrame` event loop. The array data are not copied.
...
The function for `RDataFrame`  → Awkward conversion is [`ak.from_rdataframe()`](sphinx-llm:aeb870e103be45fc91e3cba7692297ff#ak.from_rdataframe). The argument to this function accepts a tuple of strings that are the `RDataFrame` column names. By default this function returns
