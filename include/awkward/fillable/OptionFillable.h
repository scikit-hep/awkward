...
//   public:
//     OptionFillable(Fillable* content): index_(), content_(content) { }
//
//
//     OptionFillable(Fillable* content, int64_t nullcount): validindex_(), content_(content), length_(nullcount) { }
//
