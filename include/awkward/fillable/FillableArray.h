...
public:
  ...
  const std::shared_ptr<Content> getitem_range(int64_t start,
                                               int64_t stop) const;
  ...
  void string(const std::string &x) { string(x.c_str(), (int64_t)x.length()); }
  void beginlist();
  void endlist();
  ...
  void field_check(const std::string &key) { field_check(key.c_str()); }
  void endrecord();

  template <typename T> void fill(const std::vector<T> &vector) {
    beginlist();
    for (auto x : vector) {
      fill(x);
    }
...
extern "C" {
EXPORT_SYMBOL uint8_t awkward_FillableArray_length(void *fillablearray,
                                                   int64_t *result);
...
EXPORT_SYMBOL uint8_t awkward_FillableArray_boolean(void *fillablearray,
                                                    bool x);
EXPORT_SYMBOL uint8_t awkward_FillableArray_integer(void *fillablearray,
                                                    int64_t x);
EXPORT_SYMBOL uint8_t awkward_FillableArray_real(void *fillablearray, double x);
EXPORT_SYMBOL uint8_t awkward_FillableArray_bytestring(void *fillablearray,
                                                       const char *x);
EXPORT_SYMBOL uint8_t awkward_FillableArray_bytestring_length(
    void *fillablearray, const char *x, int64_t length);
EXPORT_SYMBOL uint8_t awkward_FillableArray_string(void *fillablearray,
                                                   const char *x);
EXPORT_SYMBOL uint8_t awkward_FillableArray_string_length(void *fillablearray,
                                                          const char *x,
                                                          int64_t length);
...
EXPORT_SYMBOL uint8_t awkward_FillableArray_begintuple(void *fillablearray,
                                                       int64_t numfields);
EXPORT_SYMBOL uint8_t awkward_FillableArray_index(void *fillablearray,
                                                  int64_t index);
...
awkward_FillableArray_beginrecord_fast(void *fillablearray, const char *name);
EXPORT_SYMBOL uint8_t
awkward_FillableArray_beginrecord_check(void *fillablearray, const char *name);
EXPORT_SYMBOL uint8_t awkward_FillableArray_field_fast(void *fillablearray,
                                                       const char *key);
EXPORT_SYMBOL uint8_t awkward_FillableArray_field_check(void *fillablearray,
                                                        const char *key);
