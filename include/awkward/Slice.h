...
namespace awkward {
  ...
  class EXPORT_SYMBOL EXPORT_TYPE SliceAt: public SliceItem {
  public:
  ...
  class EXPORT_SYMBOL EXPORT_TYPE SliceRange: public SliceItem {
  public:
  ...
  /// `array[...]`).
  class EXPORT_SYMBOL EXPORT_TYPE SliceEllipsis: public SliceItem {
  public:
  ...
  /// tuple.
  class EXPORT_SYMBOL EXPORT_TYPE SliceNewAxis: public SliceItem {
  public:
  ...
  template <typename T>
  class EXPORT_SYMBOL EXPORT_TYPE SliceArrayOf: public SliceItem {
  public:
  ...
  class EXPORT_SYMBOL EXPORT_TYPE SliceField: public SliceItem {
  public:
  ...
  class EXPORT_SYMBOL EXPORT_TYPE SliceFields: public SliceItem {
  public:
  ...
  /// Currently, the only type specialization is `T = int64_t`.
  template <typename T>
  class EXPORT_SYMBOL EXPORT_TYPE SliceMissingOf: public SliceItem {
  public:
  ...
  /// Currently, the only type specialization is `T = int64_t`.
  template <typename T>
  class EXPORT_SYMBOL EXPORT_TYPE SliceJaggedOf: public SliceItem {
  public:
  ...
  class EXPORT_SYMBOL EXPORT_TYPE Slice {
  public:
