...
namespace awkward {
  ...
  class LIBAWKWARD_EXPORT_SYMBOL IrregularlyPartitionedArray final : public PartitionedArray {
  public:
    explicit IrregularlyPartitionedArray(const ContentPtrVec& partitions,
