...
namespace awkward {
  ...
  public:
    ...
    virtual const std::shared_ptr<Content> getitem_field(const std::string& field) const = 0;
    virtual const std::shared_ptr<Content> getitem_fields(const std::vector<std::string>& fields) const = 0;
