...
namespace awkward {
  ...
  public:
    ...
    virtual const std::shared_ptr<Content> reduce_next(const Reducer& reducer, int64_t negaxis, const Index64& parents, int64_t outlength, bool mask) const = 0;
    ...
    const std::shared_ptr<Content> reduce(const Reducer& reducer, int64_t axis, bool mask) const;
