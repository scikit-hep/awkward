...
extern "C" {
  ...
  EXPORT_SYMBOL struct Error awkward_unionarrayU8_32_regular_index(int32_t* toindex, const uint8_t* fromtags, int64_t tagsoffset, int64_t length);
  EXPORT_SYMBOL struct Error awkward_unionarrayU8_U32_regular_index(uint32_t* toindex, const uint8_t* fromtags, int64_t tagsoffset, int64_t length);
  EXPORT_SYMBOL struct Error awkward_unionarrayU8_64_regular_index(int64_t* toindex, const uint8_t* fromtags, int64_t tagsoffset, int64_t length);
