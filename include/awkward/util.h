...
namespace awkward {
  ...
  namespace util {
    ...
    template <typename T>
    ERROR awkward_listarray_flatten_64(T* tostarts, T* tostops, const T* fromstarts, const T* fromstops, const int64_t lenstarts, int64_t* toarray, int64_t* tolenarray);
