...
namespace awkward {
  ...
  namespace util {
    ...
    template <typename T>
    ERROR awkward_listarray_flatten_scale_64(T* tostarts, T* tostops, const int64_t* scale, const T* fromstarts, const T* fromstops,  int64_t lenstarts, int64_t startsoffset, int64_t stopsoffset, int64_t lenscale);
    template <typename T>
