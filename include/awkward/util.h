...
namespace awkward {
  ...
  namespace util {
    ...
    template <typename T>
    ERROR awkward_listarray_choose_offsets_64(int64_t** tooffsets, int64_t n, bool diagonal, const T* starts, int64_t startsoffset, const T* stops, int64_t stopsoffset, int64_t length);
