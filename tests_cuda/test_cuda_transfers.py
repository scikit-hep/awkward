...
def test_tocuda():
    ...
    cuda_array = awkward1.copy_to(array, awkward1.KernelsLib["cuda"])
    ...
    cuda_listoffsetarray = awkward1.copy_to(listoffsetarray, awkward1.KernelsLib["cuda"])
    copyback_listoffsetarray = awkward1.copy_to(cuda_listoffsetarray, awkward1.KernelsLib["cpu"])
    ...
    cuda_regulararray = awkward1.copy_to(regulararray, awkward1.KernelsLib["cuda"])
    copyback_regulararray = awkward1.copy_to(cuda_regulararray, awkward1.KernelsLib["cpu"])
    ...
    cuda_listarray = awkward1.copy_to(listarray, awkward1.KernelsLib["cuda"])
    copyback_listarray = awkward1.copy_to(cuda_listarray, awkward1.KernelsLib["cpu"])
    ...
    cuda_recordarray = awkward1.copy_to(recordarray, awkward1.KernelsLib["cuda"])
    copyback_recordarray = awkward1.copy_to(cuda_recordarray, awkward1.KernelsLib["cpu"])
    ...
    cuda_unionarray = awkward1.copy_to(unionarray, awkward1.KernelsLib["cuda"])
    copyback_unionarray = awkward1.copy_to(cuda_unionarray, awkward1.KernelsLib["cpu"])
    ...
    cuda_indexedarray = awkward1.copy_to(indexedarray, awkward1.KernelsLib["cuda"])
    copyback_indexedarray = awkward1.copy_to(cuda_indexedarray, awkward1.KernelsLib["cpu"])
    ...
    cuda_bytemaskedarray = awkward1.copy_to(bytemaskedarray, awkward1.KernelsLib["cuda"])
    copyback_bytemaskedarray = awkward1.copy_to(cuda_bytemaskedarray, awkward1.KernelsLib["cpu"])
    ...
    ioa = awkward1.layout.IndexedOptionArray32(awkward1.layout.Index32([-30, 19, 6, 7, -3, 21, 13, 22, 17, 9, -12, 16]), awkward1.layout.NumpyArray(numpy.array([5.2, 1.7, 6.7, -0.4, 4.0, 7.8, 3.8, 6.8, 4.2, 0.3, 4.6, 6.2,
                                                                                                                                                                 ...
                                                                                                                                                                 5.6, 3.8])))
    cuda_ioa = awkward1.copy_to(ioa, awkward1.KernelsLib["cuda"])
