...
listarrayA64 = ak.layout.ListArray64(ak.layout.Index64(startsA), ak.layout.Index64(stopsA), content)
...
listoffsetarrayB64 = ak.layout.ListOffsetArray64(ak.layout.Index64(offsetsB), listoffsetarrayA64)
listoffsetarrayB32 = ak.layout.ListOffsetArray32(ak.layout.Index32(offsetsB), listoffsetarrayA64)
listarrayB64 = ak.layout.ListArray64(ak.layout.Index64(startsB), ak.layout.Index64(stopsB), listarrayA64)
listarrayB32 = ak.layout.ListArray32(ak.layout.Index32(startsB), ak.layout.Index32(stopsB), listarrayA64)
