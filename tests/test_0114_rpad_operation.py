...
def test_rpad_listoffset_array():
    ...
    #                    made out of ListArray(IndexedOptionArray(???))
    # rpad-and-clip 5 at axis=1: [[1, 2, 3, None, None], [None, None, None, None, None], [4, 5, None, None, None]]
    #                            made out of RegularArray(IndexedOptionArray(???))

    # str(awkward1.typeof(array.rpad(???))) == "10 * var * ?float64"
    # str(awkward1.typeof(array.rpad(???))) == "10 * 5 * ?float64"
