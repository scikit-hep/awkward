...
def test_numpyarray():
    ...
    array1.type = awkward1.layout.RegularType(awkward1.layout.RegularType(dint64, 5), 3)
...
def test_regulararray():
    ...
    assert repr(array2.baretype) == "5 * int64"
...
def test_listoffsetarray():
    ...
    assert repr(array2.baretype) == "var * int64"
...
def test_recordarray():
    ...
    assert repr(array2.baretype) in ('{"one": int64, "two": float64}', '{"two": float64, "one": int64}')
