...
def test():
    ...
    assert np.sum(v_times_M_times_v, axis=0).tolist() == [[[3.6999999999999993, 11.6, 23.699999999999996], []], [[39.99999999999999, 60.5, 0.0, 31.2, 56.0, 88.0], []], [[127.19999999999999, 173.60000000000002, 0.0, 41.5, 61.199999999999996, 84.7], []]]
