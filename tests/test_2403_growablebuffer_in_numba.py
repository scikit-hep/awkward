...
def test_unbox():
    ...
    growablebuffer = ak.numba.GrowableBuffer(np.int32)
    f1(growablebuffer)
...
def test_box():
    ...
    growablebuffer = ak.numba.GrowableBuffer(np.int32, initial=10)
...
def test_from_data():
    ...
    out = f4()
    assert isinstance(out, ak.numba.GrowableBuffer)
...
def test_ctor():
    @numba.njit
    def f5():
        return ak.numba.GrowableBuffer("f4")
    ...
    @numba.njit
    def f6():
        return ak.numba.GrowableBuffer("f4", initial=10)
    ...
    @numba.njit
    def f7():
        return ak.numba.GrowableBuffer("f4", resize=2.0)
    ...
    @numba.njit
    def f8():
        return ak.numba.GrowableBuffer("f4", resize=2.0, initial=10)
    ...
    @numba.njit
    def f9():
        return ak.numba.GrowableBuffer(np.float32)
    ...
    @numba.njit
    def f10():
        return ak.numba.GrowableBuffer(np.dtype(np.float32))
...
def test_length_and_pos():
    ...
    growablebuffer = ak.numba.GrowableBuffer(np.float32)
...
def test_add_panel():
    ...
    growablebuffer = ak.numba.GrowableBuffer(np.float32, initial=10, resize=2.0)
...
def test_numba_append():
    ...
    def create():
        ...
        return ak.numba.GrowableBuffer(np.int32, initial=10, resize=2.0)
