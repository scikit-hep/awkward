...
def test_rpad_listoffset_array():
    ...
    assert "option[" + str(ak.operations.type(listoffsetarray)) + "]" == str(
        ak.operations.type(listoffsetarray.pad_none(3, 0))
    )
    ...
    assert "option[" + str(ak.operations.type(listoffsetarray)) + "]" == str(
        ak.operations.type(listoffsetarray.pad_none(7, 0))
    )
    ...
    assert str(ak.operations.type(listoffsetarray.pad_none(5, 1))) == "var * ?float64"
    ...
    assert f"option[{str(ak.operations.type(listoffsetarray))}]" == str(
        ak.operations.type(listoffsetarray.pad_none(1, 0))
    )
    ...
    assert "option[" + str(ak.operations.type(listoffsetarray)) + "]" == str(
        ak.operations.type(listoffsetarray.pad_none(6, 0))
    )
    ...
    assert "option[" + str(ak.operations.type(listoffsetarray)) + "]" == str(
        ak.operations.type(listoffsetarray.pad_none(9, 0))
    )
    ...
    assert str(ak.operations.type(listoffsetarray)) == str(
        ak.operations.type(listoffsetarray.pad_none(1, 1))
    )
    ...
    assert str(ak.operations.type(listoffsetarray)) == str(
        ak.operations.type(listoffsetarray.pad_none(4, 1))
    )
...
def test_rpad_list_array():
    ...
    assert f"option[{str(ak.operations.type(array))}]" == str(
        ak.operations.type(array.pad_none(1, 0))
    )
    ...
    assert f"option[{str(ak.operations.type(array))}]" == str(
        ak.operations.type(array.pad_none(2, 0))
    )
    ...
    assert "option[" + str(ak.operations.type(array)) + "]" == str(
        ak.operations.type(array.pad_none(7, 0))
    )
