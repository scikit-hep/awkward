...
def test_numpyarray_merge():
    ...
    for x, y, z in [(numpy.double, numpy.double, numpy.double),
                    ...
                    # (numpy.int64,  numpy.uint64, numpy.double),
                    ...
                    # (numpy.uint64, numpy.int64,  numpy.double),
                    # (numpy.uint64, numpy.uint64, numpy.uint64),
                    # (numpy.uint64, numpy.int32,  numpy.double),
                    # (numpy.uint64, numpy.uint32, numpy.uint64),
                    # (numpy.uint64, numpy.int16,  numpy.double),
                    # (numpy.uint64, numpy.uint16, numpy.uint64),
                    # (numpy.uint64, numpy.int8,   numpy.double),
                    # (numpy.uint64, numpy.uint8,  numpy.uint64),
                    # (numpy.uint64, numpy.bool,   numpy.uint64),
                    (numpy.int32,  numpy.double, numpy.double),
                    (numpy.int32,  numpy.float,  numpy.double),
                    (numpy.int32,  numpy.int64,  numpy.int64),
                    # (numpy.int32,  numpy.uint64, numpy.double),
                    ...
                    # (numpy.uint32, numpy.uint64, numpy.uint64),
                    ...
                    # (numpy.int16,  numpy.uint64, numpy.double),
                    ...
                    # (numpy.uint16, numpy.uint64, numpy.uint64),
                    ...
                    # (numpy.int8,   numpy.uint64, numpy.double),
                    ...
                    # (numpy.uint8,  numpy.uint64, numpy.uint64),
                    ...
                    # (numpy.bool,   numpy.uint64, numpy.uint64),
        ...
        three = one.merge(two)
        assert numpy.asarray(three).dtype == numpy.dtype(z), "{0} {1} {2} {3}".format(x, y, z, numpy.asarray(three).dtype)
