...
def test_argmin_argmax():
    ...
    assert to_list(ak.argmin(array, axis=2)) == [
        [1],
        [None],
        [None, None, None],
        [0],
...
def test_min_max():
    ...
    assert to_list(ak.min(array, axis=-1)) == [
        np.datetime64("2020-01-27T10:41:11"),
        np.datetime64("2020-01-27T10:41:11"),
        np.datetime64("2020-01-27T10:41:11"),
    ]
    assert to_list(ak.max(array, axis=-1)) == [
