...
def test_UnmaskedArray():
    content_float64 = ak.layout.NumpyArray(np.array([0.25, 0.5, 3.5, 4.5, 5.5], dtype=np.float64))
...
def test_ufunc_afterward():
    assert (ak.values_astype(ak.Array([{"x": 1.1}, {"x": 3.3}]), np.float32)["x"] + 1).tolist() == [2.0999999046325684, 4.300000190734863]

def test_string():
    assert ak.values_astype(ak.Array([{"x": 1.1, "y": "hello"}]), np.float32).tolist() == [{'x': 1.100000023841858, 'y': 'hello'}]
