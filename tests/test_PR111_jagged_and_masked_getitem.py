...
def test_bool_missing():
    ...
    assert awkward1.layout._slice_tostring(awkward1.Array([True, False, None, True, False])) == "[missing([0, -1, 1], array([0, 3]))]"
    assert awkward1.layout._slice_tostring(awkward1.Array([None, None, None])) == "[missing([-1, -1, -1], array([]))]"
