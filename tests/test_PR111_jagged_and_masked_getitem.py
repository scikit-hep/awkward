...
def test_array_slice():
    ...
    assert awkward1.tolist(array[awkward1.layout.NumpyArray(numpy.array([5, 2, 2, 3, 9, 0, 1]))]) == [5.5, 2.2, 2.2, 3.3, 9.9, 0.0, 1.1]
    assert awkward1.tolist(array[awkward1.Array(numpy.array([5, 2, 2, 3, 9, 0, 1]))]) == [5.5, 2.2, 2.2, 3.3, 9.9, 0.0, 1.1]
