...
def test_listoffset_array_1():
    ...
    value_jvp, jvp_grad = jax.jvp(func_listoffsetarray_1, (test_listoffsetarray,), (test_listoffsetarray_tangent,))
...
def test_listoffset_array_2():
    ...
    value_jvp, jvp_grad = jax.jvp(func_listoffsetarray_2, (test_listoffsetarray,), (test_listoffsetarray_tangent,))
...
def test_listoffset_array_3():
    ...
    value_jvp, jvp_grad = jax.jvp(func_listoffsetarray_3, (test_listoffsetarray,), (test_listoffsetarray_tangent,))
    ...
    assert ak.to_list(jvp_grad) == 0.0
    assert 1==2
    # assert ak.to_list(vjp_func(value_vjp)[0]) == [[2.0, 16.0, 54.0], [], [128.0, 250.0]] 
...
def test_listoffset_array_5():
    ...
    value_jvp, jvp_grad = jax.jvp(func_listoffsetarray_5, (test_listoffsetarray,), (test_listoffsetarray_tangent,))
...
def test_listoffset_array_6():
    ...
    value_jvp, jvp_grad = jax.jvp(func_listoffsetarray_6, (test_listoffsetarray,), (test_listoffsetarray_tangent,))
