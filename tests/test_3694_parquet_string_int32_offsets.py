...
def test_parquet_string_roundtrip_with_string_to32_default():
    ...
    ak.to_parquet(a, "test_string_to32.parquet")

    # Deserialize from parquet (creates int32 offsets for strings)
    x = ak.from_parquet("test_string_to32.parquet")
...
def test_parquet_string_roundtrip_explicit_string_to32_true():
    ...
    ak.to_parquet(a, "test_explicit_string_to32.parquet", string_to32=True)
    x = ak.from_parquet("test_explicit_string_to32.parquet")
...
def test_parquet_string_roundtrip_string_to32_false():
    """Test parquet roundtrip with string_to32=False."""
    a = ak.Array([{"text": "hello"}, {"text": "world"}])

    # Set string_to32=False to use int64 offsets
    ak.to_parquet(a, "test_string_to32_false.parquet", string_to32=False)
    x = ak.from_parquet("test_string_to32_false.parquet")
...
def test_parquet_bytestring_roundtrip_with_bytestring_to32():
    ...
    ak.to_parquet(a, "test_bytestring_to32.parquet", bytestring_to32=True)
    x = ak.from_parquet("test_bytestring_to32.parquet")
...
def test_direct_string_array_with_int32_offsets():
    ...
    ak.to_parquet(strings, "test_direct_strings.parquet", string_to32=True)
    x = ak.from_parquet("test_direct_strings.parquet")
...
def test_empty_strings_with_int32_offsets():
    """Test that empty strings work correctly with int32 offsets."""
    a = ak.Array([{"msg": ""}, {"msg": "x"}, {"msg": ""}])

    ak.to_parquet(a, "test_empty_strings.parquet", string_to32=True)
    x = ak.from_parquet("test_empty_strings.parquet")
...
def test_unicode_strings_with_int32_offsets():
    """Test that unicode strings work correctly with int32 offsets."""
    a = ak.Array([{"text": "Hello 👋"}, {"text": "World 🌍"}, {"text": "Test 🧪"}])

    ak.to_parquet(a, "test_unicode_strings.parquet", string_to32=True)
    x = ak.from_parquet("test_unicode_strings.parquet")
