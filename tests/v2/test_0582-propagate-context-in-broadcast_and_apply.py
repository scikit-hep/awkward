...
def test_cartesian():
    ...
    assert (
        str(ak._v2.operations.structure.cartesian([one, two], axis=0, nested=True).type)
    ...
    with pytest.raises(ValueError):
        ak._v2.operations.structure.cartesian([one, two], axis=-5, nested=True)

    assert (
        str(ak._v2.operations.structure.cartesian([one, two], axis=0).type)
        == "4 * (var * var * var * int64, var * var * var * int64)"
    )
    assert (
        str(ak._v2.operations.structure.cartesian([one, two], axis=1).type)
        == "2 * var * (var * var * int64, var * var * int64)"
    )
    assert (
        str(ak._v2.operations.structure.cartesian([one, two], axis=2).type)
        == "2 * var * var * (var * int64, var * int64)"
    )
    assert (
        str(ak._v2.operations.structure.cartesian([one, two], axis=3).type)
    ...
    assert (
        str(ak._v2.operations.structure.cartesian([one, two], axis=-4).type)
        == "4 * (var * var * var * int64, var * var * var * int64)"
    )
