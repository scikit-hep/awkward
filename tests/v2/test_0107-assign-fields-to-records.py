...
def test_record():
    ...
    array2 = array1.setitem_field("z", ak._v2.operations.convert.from_iter([[], [1], [2, 2]], highlevel=False))
    ...
    array3 = array1.setitem_field(0, ak._v2.operations.convert.from_iter([[], [1], [2, 2]], highlevel=False))
    assert to_list(array3) == [
        {"x": 1, "y": 1.1, "0": []},
        {"x": 2, "y": 2.2, "0": [1]},
        {"x": 3, "y": 3.3, "0": [2, 2]},
    ...
    array1 = ak._v2.operations.convert.from_iter([(1, 1.1), (2, 2.2), (3, 3.3)], highlevel=False)
    ...
    array3 = array1.setitem_field(1, ak._v2.operations.convert.from_iter([[], [1], [2, 2]], highlevel=False))
    assert to_list(array3) == [(1, [], 1.1), (2, [1], 2.2), (3, [2, 2], 3.3)]

    array3 = array1.setitem_field(100, ak._v2.operations.convert.from_iter([[], [1], [2, 2]], highlevel=False))
    assert to_list(array3) == [(1, 1.1, []), (2, 2.2, [1]), (3, 3.3, [2, 2])]
...
def test_withfield():
    ...
    assert to_list(ak._v2.operations.structure.with_field(base, 100, "y")) == {"x": 3, "y": 100}
...
def test_regulararray():
    ...
    assert to_list(ak._v2.operations.structure.with_field(regulararray, regulararray2, "y")) == [
    ...
    assert to_list(ak._v2.operations.structure.with_field(regulararray, content2, "y")) == [
        [{"x": 0.0, "y": 100}, {"x": 1.1, "y": 100}, {"x": 2.2, "y": 100}],
        [{"x": 3.3, "y": 200}, {"x": 4.4, "y": 200}, {"x": 5.5, "y": 200}],
        [{"x": 6.6, "y": 300}, {"x": 7.7, "y": 300}, {"x": 8.8, "y": 300}],
    ]
...
def test_listarray():
    ...
    assert to_list(ak._v2.operations.structure.with_field(one, [100, 200, 300], "y")) == [
        [{"x": 1, "y": 100}, {"x": 2, "y": 100}, {"x": 3, "y": 100}],
        [],
        [{"x": 4, "y": 300}, {"x": 5, "y": 300}],
    ]
