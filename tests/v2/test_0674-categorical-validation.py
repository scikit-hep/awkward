...
def test_categorical_is_valid():
    ...
    assert ak._v2.operations.describe.is_valid(categorical)
...
def test_optional_categorical_from_arrow():
    ...
    categorical_array = ak._v2.operations.convert.from_arrow(dict_array)
    ...
    option_categorical_array = ak._v2.operations.convert.from_arrow(option_dict_array)
...
def test_categorical_from_arrow_ChunkedArray():
    ...
    array = ak._v2.operations.convert.from_arrow(table)
    array_mixed_schema = ak._v2.operations.convert.from_arrow(table_mixed_schema)
