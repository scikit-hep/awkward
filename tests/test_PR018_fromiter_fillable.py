...
def test_types():
    t0 = awkward1.type.UnknownType()
    t1 = awkward1.type.PrimitiveType("int32")
    t2 = awkward1.type.OptionType(t1)
    t3 = awkward1.type.UnionType((t1, awkward1.type.PrimitiveType("float64")))
    t4 = awkward1.type.ListType(t1)
    t4b = awkward1.type.ListType(awkward1.type.PrimitiveType("int32"))
    t5 = awkward1.type.ListType(t4)
    t6 = awkward1.type.OptionType(t4)
