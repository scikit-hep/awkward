...
def test():
    ...
    numpyarray = ak._v2.contents.NumpyArray(np.arange(100, 200, 10))
    indexedarray = ak._v2.contents.IndexedArray(
        ak._v2.index.Index64(np.array([5, 4, 3, 2, 1, 0])), numpyarray
    )
    listoffsetarray = ak._v2.contents.ListOffsetArray(
        ak._v2.index.Index64(np.array([0, 1, 4])), indexedarray
    )
    ...
    listoffsetarray = ak._v2.contents.ListOffsetArray(
        ak._v2.index.Index64(np.array([0, 2, 4])), indexedarray
    )
    array = ak._v2.highlevel.Array(listoffsetarray)
    ...
    numpyarray = ak._v2.contents.NumpyArray(np.arange(100, 200, 10))[3:]
    indexedarray = ak._v2.contents.IndexedArray(
        ak._v2.index.Index64(np.array([5, 4, 3, 2, 1, 0])), numpyarray
    )
    listoffsetarray = ak._v2.contents.ListOffsetArray(
...
def test_zip():
    ...
    array1 = ak._v2.highlevel.Array([1.5, 2.5, 3.25])
    array2 = ak._v2.highlevel.Array([1, 2, 3])
