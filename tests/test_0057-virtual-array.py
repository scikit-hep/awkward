...
def test_forms():
    ...
    assert json.loads(form.tojson(False, True)) == {"class": "NumpyArray", "inner_shape": [1, 2, 3], "itemsize": 8, "format": "d", "primitive": "float64", "has_identities": True, "parameters": {"hey": ["you", {"there": 3}]}, "form_key": None}
    ...
    assert awkward1.forms.Form.fromjson(form.tojson(False, False)) == form
    assert awkward1.forms.Form.fromjson(form.tojson(False, True)) == form
    assert json.loads(form.tojson(False, True)) == {"class": "BitMaskedArray", "mask": "i8", "content": {"class": "NumpyArray", "inner_shape": [], "itemsize": 8, "format": "d", "primitive": "float64", "has_identities": False, "parameters": {}, "form_key": None}, "valid_when": True, "lsb_order": False, "has_identities": False, "parameters": {"hey": ["you"]}, "form_key": None}
    ...
    assert awkward1.forms.Form.fromjson(form.tojson(False, False)) == form
    assert awkward1.forms.Form.fromjson(form.tojson(False, True)) == form
    assert json.loads(form.tojson(False, True)) == {"class": "ByteMaskedArray", "mask": "i8", "content": {"class": "NumpyArray", "inner_shape": [], "itemsize": 8, "format": "d", "primitive": "float64", "has_identities": False, "parameters": {}, "form_key": None}, "valid_when": True, "has_identities": False, "parameters": {"hey": ["you"]}, "form_key": None}
    ...
    assert awkward1.forms.Form.fromjson(form.tojson(False, False)) == form
    assert awkward1.forms.Form.fromjson(form.tojson(False, True)) == form
    assert json.loads(form.tojson(False, True)) == {"class": "EmptyArray", "has_identities": False, "parameters": {"hey": ["you"]}, "form_key": None}
    ...
    assert awkward1.forms.Form.fromjson(form.tojson(False, False)) == form
    assert awkward1.forms.Form.fromjson(form.tojson(False, True)) == form
    assert json.loads(form.tojson(False, True)) == {"class": "IndexedArray64", "index": "i64", "content": {"class": "NumpyArray", "inner_shape": [], "itemsize": 8, "format": "d", "primitive": "float64", "has_identities": False, "parameters": {}, "form_key": None}, "has_identities": False, "parameters": {"hey": ["you"]}, "form_key": None}
    ...
    assert awkward1.forms.Form.fromjson(form.tojson(False, False)) == form
    assert awkward1.forms.Form.fromjson(form.tojson(False, True)) == form
    assert json.loads(form.tojson(False, True)) == {"class": "IndexedOptionArray64", "index": "i64", "content": {"class": "NumpyArray", "inner_shape": [], "itemsize": 8, "format": "d", "primitive": "float64", "has_identities": False, "parameters": {}, "form_key": None}, "has_identities": False, "parameters": {"hey": ["you"]}, "form_key": None}
    ...
    assert awkward1.forms.Form.fromjson(form.tojson(False, False)) == form
    assert awkward1.forms.Form.fromjson(form.tojson(False, True)) == form
    assert json.loads(form.tojson(False, True)) == {"class": "ListArray64", "starts": "i64", "stops": "i64", "content": {"class": "NumpyArray", "inner_shape": [], "itemsize": 8, "format": "d", "primitive": "float64", "has_identities": False, "parameters": {}, "form_key": None}, "has_identities": False, "parameters": {"hey": ["you"]}, "form_key": None}
    ...
    assert awkward1.forms.Form.fromjson(form.tojson(False, False)) == form
    assert awkward1.forms.Form.fromjson(form.tojson(False, True)) == form
    assert json.loads(form.tojson(False, True)) == {"class": "ListOffsetArray64", "offsets": "i64", "content": {"class": "NumpyArray", "inner_shape": [], "itemsize": 8, "format": "d", "primitive": "float64", "has_identities": False, "parameters": {}, "form_key": None}, "has_identities": False, "parameters": {"hey": ["you"]}, "form_key": None}
    ...
    assert awkward1.forms.Form.fromjson(form.tojson(False, False)) == form
    assert awkward1.forms.Form.fromjson(form.tojson(False, True)) == form
    assert json.loads(form.tojson(False, True)) == {"class": "RecordArray", "contents": {"one": {"class": "NumpyArray", "inner_shape": [], "itemsize": 8, "format": "d", "primitive": "float64", "has_identities": False, "parameters": {}, "form_key": None}, "two": {"class": "NumpyArray", "inner_shape": [], "itemsize": 1, "format": "?", "primitive": "bool", "has_identities": False, "parameters": {}, "form_key": None}}, "has_identities": False, "parameters": {"hey": ["you"]}, "form_key": None}
    ...
    assert awkward1.forms.Form.fromjson(form.tojson(False, False)) == form
    assert awkward1.forms.Form.fromjson(form.tojson(False, True)) == form
    assert json.loads(form.tojson(False, True)) == {"class": "RecordArray", "contents": [{"class": "NumpyArray", "inner_shape": [], "itemsize": 8, "format": "d", "primitive": "float64", "has_identities": False, "parameters": {}, "form_key": None}, {"class": "NumpyArray", "inner_shape": [], "itemsize": 1, "format": "?", "primitive": "bool", "has_identities": False, "parameters": {}, "form_key": None}], "has_identities": False, "parameters": {"hey": ["you"]}, "form_key": None}
    ...
    assert awkward1.forms.Form.fromjson(form.tojson(False, False)) == form
    assert awkward1.forms.Form.fromjson(form.tojson(False, True)) == form
    assert json.loads(form.tojson(False, True)) == {"class": "RegularArray", "content": {"class": "NumpyArray", "inner_shape": [], "itemsize": 8, "format": "d", "primitive": "float64", "has_identities": False, "parameters": {}, "form_key": None}, "size": 10, "has_identities": False, "parameters": {"hey": ["you"]}, "form_key": None}
    ...
    assert awkward1.forms.Form.fromjson(form.tojson(False, False)) == form
    assert awkward1.forms.Form.fromjson(form.tojson(False, True)) == form
    assert json.loads(form.tojson(False, True)) == {"class": "UnionArray8_64", "tags": "i8", "index": "i64", "contents": [{"class": "NumpyArray", "inner_shape": [], "itemsize": 8, "format": "d", "primitive": "float64", "has_identities": False, "parameters": {}, "form_key": None}, {"class": "NumpyArray", "inner_shape": [], "itemsize": 1, "format": "?", "primitive": "bool", "has_identities": False, "parameters": {}, "form_key": None}], "has_identities": False, "parameters": {"hey": ["you"]}, "form_key": None}
    ...
    assert awkward1.forms.Form.fromjson(form.tojson(False, False)) == form
    assert awkward1.forms.Form.fromjson(form.tojson(False, True)) == form
    assert json.loads(form.tojson(False, True)) == {"class": "UnmaskedArray", "content": {"class": "NumpyArray", "inner_shape": [], "itemsize": 8, "format": "d", "primitive": "float64", "has_identities": False, "parameters": {}, "form_key": None}, "has_identities": False, "parameters": {"hey": ["you"]}, "form_key": None}
