...
def test_mergeable_next_mergecastable():
    ...
    assert array1._mergeable_next(array2, mergebool=False, mergecastable=True)
    assert not array1._mergeable_next(array2, mergebool=False, mergecastable=False)
    ...
    assert array1._mergeable_next(array2, mergebool=False, mergecastable=True)
    assert array1._mergeable_next(array2, mergebool=False, mergecastable=False)
    ...
    assert array1._mergeable_next(array2, mergebool=False, mergecastable=True)
    assert array1._mergeable_next(array2, mergebool=False, mergecastable=False)
    assert array1._mergeable_next(array2, mergebool=True, mergecastable=True)
    assert array1._mergeable_next(array2, mergebool=True, mergecastable=False)
