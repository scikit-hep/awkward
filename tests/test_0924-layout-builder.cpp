...
int main(int, char**) {
  ...
  {
    // create builder
    ak::LayoutBuilder myarray(empty_form, options);
  ...
  }
  {
    ...
    ak::LayoutBuilder myarray(numpy_form_float64, options);
  ...
  {
    // create another builder
    ak::LayoutBuilder myarray(list_offset_form, options);
  ...
  {
    // create another builder
    ak::LayoutBuilder myarray(record_form, options);
