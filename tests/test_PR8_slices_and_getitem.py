...
def test_slice():
    ...
    print(awkward1.layout.testslice(numpy.array([1, 2, 3, 4, 5], dtype="i4")))
    print(awkward1.layout.testslice(numpy.array([1, 2, 3, 4, 5], dtype="i2")))
    print(awkward1.layout.testslice(numpy.array([1, 2, 3, 4, 5], dtype="i1")))
    print(awkward1.layout.testslice(numpy.array([1, 2, 3, 4, 5], dtype="u8")))
    print(awkward1.layout.testslice(numpy.array([1, 2, 3, 4, 5], dtype="u4")))
    print(awkward1.layout.testslice(numpy.array([1, 2, 3, 4, 5], dtype="u2")))
    print(awkward1.layout.testslice(numpy.array([1, 2, 3, 4, 5], dtype="u1")))
    print(awkward1.layout.testslice(numpy.array([1, 2, 3, 4, 5], dtype=">i8")))
    print(awkward1.layout.testslice(numpy.array([1, 2, 3, 4, 5], dtype=">i4")))
    print(awkward1.layout.testslice(numpy.array([1, 2, 3, 4, 5], dtype=">i2")))
    print(awkward1.layout.testslice(numpy.array([1, 2, 3, 4, 5], dtype=">i1")))
