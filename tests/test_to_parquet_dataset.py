...
def simple_test(path1, path2, path3):
    ...
    try:
        os.remove("/Users/zobil/Documents/awkward/tests/samples/to_parquet/_common_metadata")
        os.remove("/Users/zobil/Documents/awkward/tests/samples/to_parquet/_metadata")
    except:
        print("not there")

    no_metadata = ak.from_parquet("/Users/zobil/Documents/awkward/tests/samples/to_parquet")
    ...
    assert os.path.exists("/Users/zobil/Documents/awkward/tests/samples/to_parquet/_common_metadata")
    assert os.path.exists("/Users/zobil/Documents/awkward/tests/samples/to_parquet/_metadata")

    with_metadata = ak.from_parquet("/Users/zobil/Documents/awkward/tests/samples/to_parquet")
