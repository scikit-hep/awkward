...
h2ctypes = {
        ...
        "const bool *": ctypes.POINTER(ctypes.c_uint8),
     ...
     "const uint8_t *": ctypes.POINTER(ctypes.c_uint8),
           "int16_t *": ctypes.POINTER(ctypes.c_int16),
     "const int16_t *": ctypes.POINTER(ctypes.c_int16),
          "uint16_t *": ctypes.POINTER(ctypes.c_uint16),
    ...
    "const uint64_t *": ctypes.POINTER(ctypes.c_uint64),
